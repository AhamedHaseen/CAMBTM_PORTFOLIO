...
(function () {
  ...
  TRANSLATIONS.en = {
    ...
    'nav.systems': 'Systems', 'nav.whyCambm': 'Why CAMBM', 'nav.packages': 'Our Services', 'nav.bookCall': 'Book a strategy call',
  ...
  TRANSLATIONS.es = {
    ...
    'nav.systems': 'Sistemas', 'nav.whyCambm': 'Por qué CAMBM', 'nav.packages': 'Nuestros Servicios', 'nav.bookCall': 'Reservar una llamada',
  ...
  TRANSLATIONS.ar = {
    ...
    'nav.systems': 'الأنظمة', 'nav.whyCambm': 'لماذا كامبريدج', 'nav.packages': 'خدماتنا', 'nav.bookCall': 'احجز مكالمة استراتيجية',
  ...
  TRANSLATIONS.si = {
    ...
    'nav.systems': 'පද්ධති', 'nav.whyCambm': 'මන්ද කැම්බ්‍රිජ්', 'nav.packages': 'අපගේ සේවාවන්', 'nav.bookCall': 'උපායමාර්ග ඇමතුමක් වෙන් කරන්න',
  ...
  TRANSLATIONS.ta = {
    ...
    'nav.systems': 'அமைப்புகள்', 'nav.whyCambm': 'ஏன் கேம்ப்ரிட்ஜ்', 'nav.packages': 'எங்கள் சேவைகள்', 'nav.bookCall': 'மூலோபாய அழைப்பை பதிவு செய்யவும்',
