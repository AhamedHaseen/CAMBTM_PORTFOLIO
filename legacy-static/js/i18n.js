...
(function () {
  ...
  const HTML_KEYS = {
    'hero.title': true, 'ai.title': true, 'ai.desc': true, 'diff.title': true, 'comparison.title': true,
  ...
  TRANSLATIONS.en = {
    ...
    'nav.systems': 'Systems', 'nav.whyCambm': 'Why CAMBM', 'nav.services': 'Services', 'nav.packages': 'Packages', 'nav.ourProducts': 'Our Products', 'nav.ourProjects': 'Our Products', 'nav.ourPricing': 'Pricing', 'nav.bookCall': 'Book a strategy call',
    ...
    'ai.title': 'One <em>Connected</em> System for Growth,<br>Technology and Operations.',
    'ai.desc': 'Businesses do not grow through marketing alone. Sustainable growth depends on how well your brand, campaigns, website, sales tools, and internal systems work together.<br><br>Cambridge Marketing brings these functions into one connected ecosystem. From attracting the right audience to converting leads, managing sales, automating workflows, and tracking performance, every part is designed to support the same business objective.',
    'ai.feature1Title': 'Brand Strategy & Creative Direction', 'ai.feature1Desc': 'A clear brand system supported by strategic campaigns, consistent content, and professional creative that strengthens how your business is recognised.',
    'ai.feature2Title': 'Social Media & Performance Advertising', 'ai.feature2Desc': 'Purpose-driven content and targeted campaigns across Meta, TikTok, and Google, focused on reaching relevant audiences and generating qualified opportunities.',
    'ai.feature3Title': 'Websites & Conversion Experiences', 'ai.feature3Desc': 'Fast, credible websites and landing pages that communicate value clearly and guide visitors towards enquiries, bookings, or purchases.',
    'ai.feature4Title': 'POS & ERP Solutions', 'ai.feature4Desc': 'Custom systems that connect billing, inventory, sales, reporting, and operations, giving your team greater control and reducing disconnected processes.',
    'ai.feature5Title': 'AI Automation & Lead Management', 'ai.feature5Desc': 'Automated lead capture, follow-ups, customer journeys, and routine workflows that improve response times and keep opportunities moving.',
    'ai.feature6Title': 'Reporting & Business Intelligence', 'ai.feature6Desc': 'Clear performance insights across marketing, leads, sales, and operations, helping you identify what works and make better-informed decisions.',
    ...
    'comparison.title': 'Hiring In-House of Traditional Outsourcing?<br><em>Neither</em>',
    'comparison.supporting': 'Build one connected growth system instead of managing separate people, platforms and providers',
    'comparison.requirement': 'What Your Business Needs', 'comparison.hiringInHouse': 'Hiring In-House',
    'comparison.traditionalOutsourcing': 'Traditional Outsourcing', 'comparison.cambm': 'Cambridge Marketing',
    'comparison.strategy': 'Growth Strategy', 'comparison.strategyInHouse': 'Requires experienced senior talent and internal management',
    'comparison.strategyOutsourcing': 'Strategy can become fragmented across providers', 'comparison.strategyCambm': 'One growth strategy connecting marketing, technology and operations',
    'comparison.creative': 'Creative & Content', 'comparison.creativeInHouse': 'Requires designers, editors and content specialists',
    'comparison.creativeOutsourcing': 'Usually delivered request by request', 'comparison.creativeCambm': 'Planned creative built around campaigns and business objectives',
    'comparison.metaAds': 'Meta & TikTok Ads', 'comparison.metaAdsInHouse': 'Requires dedicated performance expertise',
    'comparison.metaAdsOutsourcing': 'Often managed separately from creative and strategy', 'comparison.metaAdsCambm': 'Campaigns, creative and optimisation managed as one system',
    'comparison.googleAds': 'Google Ads', 'comparison.googleAdsInHouse': 'Requires specialist search and conversion expertise',
    'comparison.googleAdsOutsourcing': 'Usually another specialist or agency', 'comparison.googleAdsCambm': 'Search, performance and landing pages aligned around conversions',
    'comparison.website': 'Website & E-Commerce', 'comparison.websiteInHouse': 'Requires development, maintenance and marketing coordination',
    'comparison.websiteOutsourcing': 'Website and marketing are often handled separately', 'comparison.websiteCambm': 'Websites and e-commerce built to support marketing, sales and operations',
    'comparison.posSoftware': 'POS Software', 'comparison.posSoftwareInHouse': 'Requires a separate software provider and implementation team',
    'comparison.posSoftwareOutsourcing': 'Often disconnected from your website and marketing', 'comparison.posSoftwareCambm': 'Custom POS systems connected to e-commerce, inventory and business workflows',
    'comparison.erp': 'ERP & Business Systems', 'comparison.erpInHouse': 'Expensive to build and maintain internally',
    'comparison.erpOutsourcing': 'Usually implemented as a standalone system', 'comparison.erpCambm': 'ERP, POS, website and operational systems designed to work together',
    'comparison.aiAutomation': 'AI Automations & Agents', 'comparison.aiAutomationInHouse': 'Requires specialised AI and automation talent',
    'comparison.aiAutomationOutsourcing': 'Often added as isolated tools', 'comparison.aiAutomationCambm': 'AI agents and automations integrated into sales, support, marketing and operations',
    'comparison.reporting': 'Reporting & Data', 'comparison.reportingInHouse': 'Data sits across different teams and platforms',
    'comparison.reportingOutsourcing': 'Reports arrive from multiple providers', 'comparison.reportingCambm': 'Marketing, sales and operational data brought into one clearer view',
    'comparison.management': 'Management & Accountability', 'comparison.managementInHouse': 'You recruit, brief and manage everyone',
    'comparison.managementOutsourcing': 'You coordinate multiple agencies and vendors', 'comparison.managementCambm': 'One partner. One workflow. One accountable team.',
    'comparison.conclusion': 'Your Ads should talk to your website. Your Website should talk to your POS.<br>Your POS should talk to your Inventory. Your Data should inform what happens next.',
    ...
    'footer.office.label': 'Our offices', 'footer.office.phone': 'Contact number', 'footer.office.address': 'Address', 'footer.office.email': 'Email',
    'footer.office.sa.title': 'Cambridge Marketing - Saudi Arabia', 'footer.office.sa.address': 'City Centre, Mishrifah, Jeddah, Saudi Arabia',
    'footer.office.lk.title': 'Cambridge Marketing - Sri Lanka', 'footer.office.lk.address': '328/3 Temple Road, Kaduwela Road, Battaramulla, Colombo, Sri Lanka 10120',
    ...
    'contact.quickActions': 'Quick contact', 'contact.whatsappAria': 'Chat on WhatsApp', 'contact.callAria': 'Call Cambridge Marketing',
  ...
  TRANSLATIONS.es = {
    ...
    'nav.systems': 'Sistemas', 'nav.whyCambm': 'Por qué CAMBM', 'nav.services': 'Servicios', 'nav.packages': 'Paquetes', 'nav.ourProducts': 'Nuestros Productos', 'nav.ourProjects': 'Nuestros Productos', 'nav.ourPricing': 'Nuestros Precios', 'nav.bookCall': 'Reservar una llamada',
    ...
    'ai.title': 'Un sistema <em>conectado</em> para el crecimiento,<br>la tecnología y las operaciones.',
    'ai.desc': 'Las empresas no crecen solo a través del marketing. El crecimiento sostenible depende de qué tan bien trabajan en conjunto tu marca, campañas, sitio web, herramientas de ventas y sistemas internos.<br><br>Cambridge Marketing reúne estas funciones en un ecosistema conectado. Desde atraer a la audiencia adecuada hasta convertir clientes potenciales, gestionar ventas, automatizar flujos de trabajo y medir el rendimiento, cada parte está diseñada para apoyar el mismo objetivo empresarial.',
    'ai.feature1Title': 'Estrategia de marca y dirección creativa', 'ai.feature1Desc': 'Un sistema de marca claro respaldado por campañas estratégicas, contenido consistente y creatividad profesional que fortalece el reconocimiento de tu empresa.',
    'ai.feature2Title': 'Redes sociales y publicidad de rendimiento', 'ai.feature2Desc': 'Contenido con propósito y campañas segmentadas en Meta, TikTok y Google, enfocadas en llegar a audiencias relevantes y generar oportunidades cualificadas.',
    'ai.feature3Title': 'Sitios web y experiencias de conversión', 'ai.feature3Desc': 'Sitios web y landing pages rápidos y fiables que comunican el valor con claridad y guían a los visitantes hacia consultas, reservas o compras.',
    'ai.feature4Title': 'Soluciones POS y ERP', 'ai.feature4Desc': 'Sistemas personalizados que conectan facturación, inventario, ventas, informes y operaciones, dando a tu equipo mayor control y reduciendo procesos desconectados.',
    'ai.feature5Title': 'Automatización con IA y gestión de clientes potenciales', 'ai.feature5Desc': 'Captación automática de clientes potenciales, seguimientos, recorridos del cliente y flujos rutinarios que mejoran los tiempos de respuesta y mantienen las oportunidades en movimiento.',
    'ai.feature6Title': 'Informes e inteligencia empresarial', 'ai.feature6Desc': 'Información clara sobre el rendimiento de marketing, clientes potenciales, ventas y operaciones para identificar qué funciona y tomar decisiones mejor fundamentadas.',
    ...
    'comparison.title': '¿Contratación interna o subcontratación tradicional?<br><em>Ninguna</em>',
    'comparison.supporting': 'Construye un sistema de crecimiento conectado en lugar de gestionar personas, plataformas y proveedores por separado',
    'comparison.requirement': 'Lo que tu empresa necesita', 'comparison.hiringInHouse': 'Contratación interna',
    'comparison.traditionalOutsourcing': 'Subcontratación tradicional', 'comparison.cambm': 'Cambridge Marketing',
    'comparison.strategy': 'Estrategia de crecimiento', 'comparison.strategyInHouse': 'Requiere talento senior experimentado y gestión interna',
    'comparison.strategyOutsourcing': 'La estrategia puede fragmentarse entre proveedores', 'comparison.strategyCambm': 'Una estrategia de crecimiento que conecta marketing, tecnología y operaciones',
    'comparison.creative': 'Creatividad y contenido', 'comparison.creativeInHouse': 'Requiere diseñadores, editores y especialistas en contenido',
    'comparison.creativeOutsourcing': 'Suele entregarse solicitud por solicitud', 'comparison.creativeCambm': 'Creatividad planificada alrededor de campañas y objetivos empresariales',
    'comparison.metaAds': 'Anuncios de Meta y TikTok', 'comparison.metaAdsInHouse': 'Requiere experiencia dedicada en rendimiento',
    'comparison.metaAdsOutsourcing': 'A menudo se gestiona por separado de la creatividad y la estrategia', 'comparison.metaAdsCambm': 'Campañas, creatividad y optimización gestionadas como un solo sistema',
    'comparison.googleAds': 'Google Ads', 'comparison.googleAdsInHouse': 'Requiere experiencia especializada en búsqueda y conversión',
    'comparison.googleAdsOutsourcing': 'Suele requerir otro especialista o agencia', 'comparison.googleAdsCambm': 'Búsqueda, rendimiento y landing pages alineados con las conversiones',
    'comparison.website': 'Sitio web y comercio electrónico', 'comparison.websiteInHouse': 'Requiere coordinación de desarrollo, mantenimiento y marketing',
    'comparison.websiteOutsourcing': 'El sitio web y el marketing suelen gestionarse por separado', 'comparison.websiteCambm': 'Sitios web y e-commerce creados para apoyar marketing, ventas y operaciones',
    'comparison.posSoftware': 'Software POS', 'comparison.posSoftwareInHouse': 'Requiere un proveedor de software y un equipo de implementación separados',
    'comparison.posSoftwareOutsourcing': 'A menudo está desconectado del sitio web y del marketing', 'comparison.posSoftwareCambm': 'Sistemas POS conectados con e-commerce, inventario y flujos empresariales',
    'comparison.erp': 'ERP y sistemas empresariales', 'comparison.erpInHouse': 'Costoso de crear y mantener internamente',
    'comparison.erpOutsourcing': 'Suele implementarse como un sistema independiente', 'comparison.erpCambm': 'ERP, POS, sitio web y sistemas operativos diseñados para trabajar juntos',
    'comparison.aiAutomation': 'Automatizaciones y agentes de IA', 'comparison.aiAutomationInHouse': 'Requiere talento especializado en IA y automatización',
    'comparison.aiAutomationOutsourcing': 'Suelen añadirse como herramientas aisladas', 'comparison.aiAutomationCambm': 'Agentes y automatizaciones integrados en ventas, soporte, marketing y operaciones',
    'comparison.reporting': 'Informes y datos', 'comparison.reportingInHouse': 'Los datos están repartidos entre equipos y plataformas',
    'comparison.reportingOutsourcing': 'Los informes llegan de varios proveedores', 'comparison.reportingCambm': 'Datos de marketing, ventas y operaciones reunidos en una visión más clara',
    'comparison.management': 'Gestión y responsabilidad', 'comparison.managementInHouse': 'Tú contratas, informas y gestionas a todos',
    'comparison.managementOutsourcing': 'Tú coordinas varias agencias y proveedores', 'comparison.managementCambm': 'Un socio. Un flujo de trabajo. Un equipo responsable.',
    'comparison.conclusion': 'Tus anuncios deben comunicarse con tu sitio web. Tu sitio web debe comunicarse con tu POS.<br>Tu POS debe comunicarse con tu inventario. Tus datos deben informar lo que sucede después.',
    'comparison.integratedGrowth': 'Esto es lo que entendemos por crecimiento integrado',
    ...
    'footer.office.label': 'Nuestras oficinas', 'footer.office.phone': 'Número de contacto', 'footer.office.address': 'Dirección', 'footer.office.email': 'Correo electrónico',
    'footer.office.sa.title': 'Cambridge Marketing - Arabia Saudita', 'footer.office.sa.address': 'City Centre, Mishrifah, Yeda, Arabia Saudita',
    'footer.office.lk.title': 'Cambridge Marketing - Sri Lanka', 'footer.office.lk.address': '328/3 Temple Road, Kaduwela Road, Battaramulla, Colombo, Sri Lanka 10120',
    ...
    'contact.quickActions': 'Contacto rápido', 'contact.whatsappAria': 'Chatear por WhatsApp', 'contact.callAria': 'Llamar a Cambridge Marketing',
  ...
  TRANSLATIONS.ar = {
    ...
    'nav.systems': 'الأنظمة', 'nav.whyCambm': 'لماذا كامبريدج', 'nav.services': 'الخدمات', 'nav.packages': 'الباقات', 'nav.ourProducts': 'منتجاتنا', 'nav.ourProjects': 'منتجاتنا', 'nav.ourPricing': 'أسعارنا', 'nav.bookCall': 'احجز مكالمة استراتيجية',
    ...
    'ai.desc': 'لا تنمو الأعمال من خلال التسويق وحده. يعتمد النمو المستدام على مدى تكامل علامتك التجارية وحملاتك وموقعك وأدوات المبيعات وأنظمتك الداخلية.<br><br>تجمع كامبريدج للتسويق هذه الوظائف في منظومة واحدة مترابطة. من جذب الجمهور المناسب وتحويل العملاء المحتملين إلى إدارة المبيعات وأتمتة سير العمل وتتبع الأداء، صُمم كل جزء لدعم هدف العمل نفسه.',
    'ai.feature1Title': 'استراتيجية العلامة والتوجيه الإبداعي', 'ai.feature1Desc': 'نظام واضح للعلامة تدعمه حملات استراتيجية ومحتوى متسق وإبداع احترافي يعزز طريقة التعرف على أعمالك.',
    'ai.feature2Title': 'وسائل التواصل وإعلانات الأداء', 'ai.feature2Desc': 'محتوى هادف وحملات مستهدفة عبر Meta وTikTok وGoogle، تركز على الوصول إلى الجمهور المناسب وتوليد فرص مؤهلة.',
    'ai.feature3Title': 'المواقع وتجارب التحويل', 'ai.feature3Desc': 'مواقع وصفحات هبوط سريعة وموثوقة توضح القيمة وتوجه الزوار نحو الاستفسارات أو الحجوزات أو المشتريات.',
    'ai.feature4Title': 'حلول نقاط البيع وتخطيط الموارد', 'ai.feature4Desc': 'أنظمة مخصصة تربط الفوترة والمخزون والمبيعات والتقارير والعمليات، لتمنح فريقك تحكمًا أكبر وتقلل العمليات المنفصلة.',
    'ai.feature5Title': 'أتمتة الذكاء الاصطناعي وإدارة العملاء المحتملين', 'ai.feature5Desc': 'التقاط آلي للعملاء المحتملين ومتابعات ورحلات عملاء ومسارات عمل روتينية تحسن سرعة الاستجابة وتحافظ على تقدم الفرص.',
    'ai.feature6Title': 'التقارير وذكاء الأعمال', 'ai.feature6Desc': 'رؤى واضحة لأداء التسويق والعملاء المحتملين والمبيعات والعمليات، تساعدك على تحديد ما ينجح واتخاذ قرارات أفضل.',
    ...
    'comparison.supporting': 'ابنِ نظام نمو مترابطًا بدلًا من إدارة أشخاص ومنصات ومزودين منفصلين',
    'comparison.requirement': 'ما يحتاجه عملك', 'comparison.hiringInHouse': 'التوظيف الداخلي',
    'comparison.traditionalOutsourcing': 'الاستعانة بمصادر خارجية تقليدية', 'comparison.cambm': 'كامبريدج للتسويق',
    'comparison.strategy': 'استراتيجية النمو', 'comparison.strategyInHouse': 'يتطلب خبرات قيادية متمرسة وإدارة داخلية',
    'comparison.strategyOutsourcing': 'قد تصبح الاستراتيجية مجزأة بين عدة مزودين', 'comparison.strategyCambm': 'استراتيجية نمو واحدة تربط التسويق والتقنية والعمليات',
    'comparison.creative': 'الإبداع والمحتوى', 'comparison.creativeInHouse': 'يتطلب مصممين ومحررين ومتخصصين في المحتوى',
    'comparison.creativeOutsourcing': 'يُقدَّم عادةً طلبًا بعد طلب', 'comparison.creativeCambm': 'إبداع مخطط حول الحملات وأهداف العمل',
    'comparison.metaAds': 'إعلانات Meta وTikTok', 'comparison.metaAdsInHouse': 'يتطلب خبرة متخصصة في الأداء',
    'comparison.metaAdsOutsourcing': 'غالبًا ما يُدار منفصلًا عن الإبداع والاستراتيجية', 'comparison.metaAdsCambm': 'الحملات والإبداع والتحسين تُدار كنظام واحد',
    'comparison.googleAds': 'إعلانات Google', 'comparison.googleAdsInHouse': 'يتطلب خبرة متخصصة في البحث والتحويل',
    'comparison.googleAdsOutsourcing': 'يتطلب عادةً متخصصًا أو وكالة أخرى', 'comparison.googleAdsCambm': 'البحث والأداء وصفحات الهبوط متوافقة حول التحويلات',
    'comparison.website': 'الموقع والتجارة الإلكترونية', 'comparison.websiteInHouse': 'يتطلب تنسيق التطوير والصيانة والتسويق',
    'comparison.websiteOutsourcing': 'غالبًا ما تتم إدارة الموقع والتسويق بشكل منفصل', 'comparison.websiteCambm': 'مواقع وتجارة إلكترونية تدعم التسويق والمبيعات والعمليات',
    'comparison.posSoftware': 'نظام نقاط البيع', 'comparison.posSoftwareInHouse': 'يتطلب مزود برمجيات وفريق تنفيذ منفصلين',
    'comparison.posSoftwareOutsourcing': 'غالبًا ما يكون منفصلًا عن موقعك وتسويقك', 'comparison.posSoftwareCambm': 'أنظمة نقاط بيع مخصصة مرتبطة بالتجارة الإلكترونية والمخزون وسير العمل',
    'comparison.erp': 'تخطيط الموارد وأنظمة الأعمال', 'comparison.erpInHouse': 'مكلف في البناء والصيانة داخليًا',
    'comparison.erpOutsourcing': 'يُنفذ عادةً كنظام مستقل', 'comparison.erpCambm': 'أنظمة ERP ونقاط البيع والموقع والعمليات مصممة للعمل معًا',
    'comparison.aiAutomation': 'أتمتة ووكلاء الذكاء الاصطناعي', 'comparison.aiAutomationInHouse': 'يتطلب مواهب متخصصة في الذكاء الاصطناعي والأتمتة',
    'comparison.aiAutomationOutsourcing': 'غالبًا ما تُضاف كأدوات معزولة', 'comparison.aiAutomationCambm': 'وكلاء وأتمتة مدمجون في المبيعات والدعم والتسويق والعمليات',
    'comparison.reporting': 'التقارير والبيانات', 'comparison.reportingInHouse': 'تتوزع البيانات بين فرق ومنصات مختلفة',
    'comparison.reportingOutsourcing': 'تصل التقارير من عدة مزودين', 'comparison.reportingCambm': 'بيانات التسويق والمبيعات والعمليات في رؤية واحدة أوضح',
    'comparison.management': 'الإدارة والمساءلة', 'comparison.managementInHouse': 'أنت توظف وتوجّه وتدير الجميع',
    'comparison.managementOutsourcing': 'أنت تنسق بين عدة وكالات ومزودين', 'comparison.managementCambm': 'شريك واحد. سير عمل واحد. فريق واحد مسؤول.',
    'comparison.conclusion': 'يجب أن تتواصل إعلاناتك مع موقعك. ويجب أن يتواصل موقعك مع نظام نقاط البيع.<br>ويجب أن يتواصل نظام نقاط البيع مع المخزون. ويجب أن تحدد بياناتك ما يحدث بعد ذلك.',
    ...
    'footer.office.label': 'مكاتبنا', 'footer.office.phone': 'رقم التواصل', 'footer.office.address': 'العنوان', 'footer.office.email': 'البريد الإلكتروني',
    'footer.office.sa.title': 'كامبريدج ماركتنج - المملكة العربية السعودية', 'footer.office.sa.address': 'سيتي سنتر، مشرفة، جدة، المملكة العربية السعودية',
    'footer.office.lk.title': 'كامبريدج ماركتنج - سريلانكا', 'footer.office.lk.address': '328/3 Temple Road, Kaduwela Road, Battaramulla, Colombo, Sri Lanka 10120',
    ...
    'contact.quickActions': 'تواصل سريع', 'contact.whatsappAria': 'تحدث معنا عبر واتساب', 'contact.callAria': 'اتصل بكامبريدج ماركتنج',
  ...
  TRANSLATIONS.si = {
    ...
    'nav.systems': 'පද්ධති', 'nav.whyCambm': 'මන්ද කැම්බ්‍රිජ්', 'nav.services': 'සේවා', 'nav.packages': 'පැකේජ', 'nav.ourProducts': 'අපගේ නිෂ්පාදන', 'nav.ourProjects': 'අපගේ නිෂ්පාදන', 'nav.ourPricing': 'අපගේ මිල ගණන්', 'nav.bookCall': 'උපායමාර්ග ඇමතුමක් වෙන් කරන්න',
    ...
    'ai.title': 'වර්ධනය සඳහා එක් <em>සම්බන්ධිත</em> පද්ධතියක්,<br>තාක්ෂණය සහ මෙහෙයුම් සඳහා.',
    'ai.desc': 'ව්‍යාපාර අලෙවිකරණයෙන් පමණක් වර්ධනය නොවේ. තිරසාර වර්ධනය රඳා පවතින්නේ ඔබේ වෙළඳ නාමය, ප්‍රචාරණ, වෙබ් අඩවිය, විකුණුම් මෙවලම් සහ අභ්‍යන්තර පද්ධති එකට කෙතරම් හොඳින් ක්‍රියා කරනවාද යන්න මතයි.<br><br>Cambridge Marketing මෙම කාර්යයන් එක් සම්බන්ධිත පරිසර පද්ධතියකට ගෙන එයි. නිවැරදි ප්‍රේක්ෂකයා ආකර්ෂණය කිරීමේ සිට ලීඩ් පරිවර්තනය, විකුණුම් කළමනාකරණය, වැඩ ප්‍රවාහ ස්වයංක්‍රීයකරණය සහ කාර්යසාධනය නිරීක්ෂණය දක්වා සෑම කොටසක්ම එකම ව්‍යාපාරික අරමුණට සහාය වීමට නිර්මාණය කර ඇත.',
    'ai.feature1Title': 'වෙළඳ නාම උපායමාර්ගය සහ නිර්මාණාත්මක මගපෙන්වීම', 'ai.feature1Desc': 'උපායමාර්ගික ප්‍රචාරණ, ස්ථාවර අන්තර්ගතය සහ ඔබේ ව්‍යාපාරය හඳුනාගන්නා ආකාරය ශක්තිමත් කරන වෘත්තීය නිර්මාණශීලීත්වයෙන් සහාය ලබන පැහැදිලි වෙළඳ නාම පද්ධතියක්.',
    'ai.feature2Title': 'සමාජ මාධ්‍ය සහ කාර්යසාධන දැන්වීම්', 'ai.feature2Desc': 'අදාළ ප්‍රේක්ෂකයන් වෙත ළඟා වීම සහ සුදුසු අවස්ථා උත්පාදනය කිරීම කෙරෙහි අවධානය යොමු කළ Meta, TikTok සහ Google හි අරමුණු සහිත අන්තර්ගත සහ ඉලක්කගත ප්‍රචාරණ.',
    'ai.feature3Title': 'වෙබ් අඩවි සහ පරිවර්තන අත්දැකීම්', 'ai.feature3Desc': 'වටිනාකම පැහැදිලිව සන්නිවේදනය කර අමුත්තන් විමසීම්, වෙන් කිරීම් හෝ මිලදී ගැනීම් වෙත යොමු කරන වේගවත් සහ විශ්වාසනීය වෙබ් අඩවි සහ ලෑන්ඩින් පිටු.',
    'ai.feature4Title': 'POS සහ ERP විසඳුම්', 'ai.feature4Desc': 'බිල්පත්, තොග, විකුණුම්, වාර්තා සහ මෙහෙයුම් සම්බන්ධ කර ඔබේ කණ්ඩායමට වැඩි පාලනයක් ලබා දෙන සහ වෙන්වූ ක්‍රියාවලි අඩු කරන අභිරුචි පද්ධති.',
    'ai.feature5Title': 'AI ස්වයංක්‍රීයකරණය සහ ලීඩ් කළමනාකරණය', 'ai.feature5Desc': 'ප්‍රතිචාර කාලය වැඩිදියුණු කර අවස්ථා ඉදිරියට ගෙන යන ස්වයංක්‍රීය ලීඩ් එකතු කිරීම, පසු විපරම්, පාරිභෝගික ගමන් සහ සාමාන්‍ය වැඩ ප්‍රවාහ.',
    'ai.feature6Title': 'වාර්තාකරණය සහ ව්‍යාපාරික බුද්ධිය', 'ai.feature6Desc': 'අලෙවිකරණය, ලීඩ්, විකුණුම් සහ මෙහෙයුම් හරහා පැහැදිලි කාර්යසාධන දත්ත, ක්‍රියාත්මක වන දේ හඳුනාගෙන වඩා හොඳ තීරණ ගැනීමට උපකාරී වේ.',
    ...
    'comparison.title': 'අභ්‍යන්තර බඳවා ගැනීමද, සාම්ප්‍රදායික බාහිර සේවාද?<br><em>දෙකම නොවේ</em>',
    'comparison.supporting': 'වෙන් වෙන් පුද්ගලයන්, වේදිකා සහ සැපයුම්කරුවන් කළමනාකරණය කිරීම වෙනුවට එකිනෙකට සම්බන්ධ වර්ධන පද්ධතියක් ගොඩනඟන්න',
    'comparison.requirement': 'ඔබේ ව්‍යාපාරයට අවශ්‍ය දේ', 'comparison.hiringInHouse': 'අභ්‍යන්තර බඳවා ගැනීම',
    'comparison.traditionalOutsourcing': 'සාම්ප්‍රදායික බාහිර සේවා', 'comparison.cambm': 'කැම්බ්‍රිජ් මාර්කටින්',
    'comparison.strategy': 'වර්ධන උපායමාර්ගය', 'comparison.strategyInHouse': 'පළපුරුදු ජ්‍යෙෂ්ඨ දක්ෂතා සහ අභ්‍යන්තර කළමනාකරණය අවශ්‍යයි',
    'comparison.strategyOutsourcing': 'උපායමාර්ගය සැපයුම්කරුවන් අතර කොටස්වලට බෙදී යා හැක', 'comparison.strategyCambm': 'අලෙවිකරණය, තාක්ෂණය සහ මෙහෙයුම් සම්බන්ධ කරන එක් වර්ධන උපායමාර්ගයක්',
    'comparison.creative': 'නිර්මාණ සහ අන්තර්ගතය', 'comparison.creativeInHouse': 'නිර්මාණකරුවන්, සංස්කාරකවරුන් සහ අන්තර්ගත විශේෂඥයන් අවශ්‍යයි',
    'comparison.creativeOutsourcing': 'සාමාන්‍යයෙන් ඉල්ලීමෙන් ඉල්ලීමට ලබා දෙයි', 'comparison.creativeCambm': 'ප්‍රචාරණ සහ ව්‍යාපාරික අරමුණු වටා සැලසුම් කළ නිර්මාණ',
    'comparison.metaAds': 'Meta සහ TikTok දැන්වීම්', 'comparison.metaAdsInHouse': 'කැපවූ කාර්යසාධන විශේෂඥතාව අවශ්‍යයි',
    'comparison.metaAdsOutsourcing': 'නිර්මාණ සහ උපායමාර්ගයෙන් වෙන්ව බොහෝවිට කළමනාකරණය කරයි', 'comparison.metaAdsCambm': 'ප්‍රචාරණ, නිර්මාණ සහ ප්‍රශස්තකරණය එක් පද්ධතියක් ලෙස කළමනාකරණය කරයි',
    'comparison.googleAds': 'Google දැන්වීම්', 'comparison.googleAdsInHouse': 'සෙවීම් සහ පරිවර්තන විශේෂඥතාව අවශ්‍යයි',
    'comparison.googleAdsOutsourcing': 'සාමාන්‍යයෙන් තවත් විශේෂඥයෙකු හෝ ඒජන්සියක් අවශ්‍යයි', 'comparison.googleAdsCambm': 'සෙවීම්, කාර්යසාධනය සහ ලෑන්ඩින් පිටු පරිවර්තන වටා පෙළගස්වයි',
    'comparison.website': 'වෙබ් අඩවිය සහ ඊ-වාණිජ්‍යය', 'comparison.websiteInHouse': 'සංවර්ධනය, නඩත්තුව සහ අලෙවිකරණ සම්බන්ධීකරණය අවශ්‍යයි',
    'comparison.websiteOutsourcing': 'වෙබ් අඩවිය සහ අලෙවිකරණය බොහෝවිට වෙන වෙනම කළමනාකරණය කරයි', 'comparison.websiteCambm': 'අලෙවිකරණය, අලෙවිය සහ මෙහෙයුම් සඳහා සහාය වන වෙබ් අඩවි සහ ඊ-වාණිජ්‍යය',
    'comparison.posSoftware': 'POS මෘදුකාංගය', 'comparison.posSoftwareInHouse': 'වෙනම මෘදුකාංග සැපයුම්කරුවෙකු සහ ක්‍රියාත්මක කිරීමේ කණ්ඩායමක් අවශ්‍යයි',
    'comparison.posSoftwareOutsourcing': 'ඔබේ වෙබ් අඩවියෙන් සහ අලෙවිකරණයෙන් බොහෝවිට වෙන්ව පවතී', 'comparison.posSoftwareCambm': 'ඊ-වාණිජ්‍යය, තොග සහ ව්‍යාපාර කාර්ය ප්‍රවාහ සමඟ සම්බන්ධ අභිරුචි POS පද්ධති',
    'comparison.erp': 'ERP සහ ව්‍යාපාරික පද්ධති', 'comparison.erpInHouse': 'අභ්‍යන්තරව ගොඩනැඟීම සහ නඩත්තු කිරීම මිල අධිකයි',
    'comparison.erpOutsourcing': 'සාමාන්‍යයෙන් ස්වාධීන පද්ධතියක් ලෙස ක්‍රියාත්මක කරයි', 'comparison.erpCambm': 'ERP, POS, වෙබ් අඩවිය සහ මෙහෙයුම් පද්ධති එකට වැඩ කිරීමට නිර්මාණය කර ඇත',
    'comparison.aiAutomation': 'AI ස්වයංක්‍රීයකරණ සහ නියෝජිතයන්', 'comparison.aiAutomationInHouse': 'විශේෂිත AI සහ ස්වයංක්‍රීයකරණ දක්ෂතා අවශ්‍යයි',
    'comparison.aiAutomationOutsourcing': 'වෙන්වූ මෙවලම් ලෙස බොහෝවිට එකතු කරයි', 'comparison.aiAutomationCambm': 'අලෙවිය, සහාය, අලෙවිකරණය සහ මෙහෙයුම් තුළ ඒකාබද්ධ AI නියෝජිතයන් සහ ස්වයංක්‍රීයකරණ',
    'comparison.reporting': 'වාර්තාකරණය සහ දත්ත', 'comparison.reportingInHouse': 'දත්ත විවිධ කණ්ඩායම් සහ වේදිකා අතර විසිරී ඇත',
    'comparison.reportingOutsourcing': 'වාර්තා සැපයුම්කරුවන් කිහිප දෙනෙකුගෙන් ලැබේ', 'comparison.reportingCambm': 'අලෙවිකරණ, අලෙවි සහ මෙහෙයුම් දත්ත එක් පැහැදිලි දසුනකට ගෙන එයි',
    'comparison.management': 'කළමනාකරණය සහ වගවීම', 'comparison.managementInHouse': 'ඔබ සියලු දෙනා බඳවාගෙන, උපදෙස් දී කළමනාකරණය කරයි',
    'comparison.managementOutsourcing': 'ඔබ ඒජන්සි සහ සැපයුම්කරුවන් කිහිප දෙනෙකු සම්බන්ධීකරණය කරයි', 'comparison.managementCambm': 'එක් හවුල්කරුවෙක්. එක් කාර්ය ප්‍රවාහයක්. වගකිව යුතු එක් කණ්ඩායමක්.',
    'comparison.conclusion': 'ඔබේ දැන්වීම් ඔබේ වෙබ් අඩවිය සමඟ කතා කළ යුතුය. ඔබේ වෙබ් අඩවිය ඔබේ POS සමඟ කතා කළ යුතුය.<br>ඔබේ POS ඔබේ තොග සමඟ කතා කළ යුතුය. ඊළඟට සිදුවන දේ ඔබේ දත්ත මඟින් තීරණය කළ යුතුය.',
    'comparison.integratedGrowth': 'අපි ඒකාබද්ධ වර්ධනය යනුවෙන් අදහස් කරන්නේ මෙයයි',
    ...
    'footer.office.label': 'අපගේ කාර්යාල', 'footer.office.phone': 'සම්බන්ධතා අංකය', 'footer.office.address': 'ලිපිනය', 'footer.office.email': 'විද්‍යුත් තැපෑල',
    'footer.office.sa.title': 'Cambridge Marketing - සෞදි අරාබිය', 'footer.office.sa.address': 'City Centre, Mishrifah, Jeddah, සෞදි අරාබිය',
    'footer.office.lk.title': 'Cambridge Marketing - ශ්‍රී ලංකාව', 'footer.office.lk.address': '328/3 Temple Road, Kaduwela Road, Battaramulla, Colombo, Sri Lanka 10120',
    ...
    'contact.quickActions': 'ඉක්මන් සම්බන්ධතාව', 'contact.whatsappAria': 'WhatsApp මගින් කතා කරන්න', 'contact.callAria': 'Cambridge Marketing අමතන්න',
  ...
  TRANSLATIONS.ta = {
    ...
    'nav.systems': 'அமைப்புகள்', 'nav.whyCambm': 'ஏன் கேம்ப்ரிட்ஜ்', 'nav.services': 'சேவைகள்', 'nav.packages': 'தொகுப்புகள்', 'nav.ourProducts': 'எங்கள் தயாரிப்புகள்', 'nav.ourProjects': 'எங்கள் தயாரிப்புகள்', 'nav.ourPricing': 'எங்கள் விலைப்பட்டியல்', 'nav.bookCall': 'மூலோபாய அழைப்பை பதிவு செய்யவும்',
    ...
    'ai.title': 'வளர்ச்சிக்கான ஒரே <em>இணைக்கப்பட்ட</em> அமைப்பு,<br>தொழில்நுட்பம் மற்றும் செயல்பாடுகளுக்காக.',
    'ai.desc': 'வணிகங்கள் சந்தைப்படுத்தலால் மட்டும் வளர்வதில்லை. நிலையான வளர்ச்சி என்பது உங்கள் பிராண்டு, பிரச்சாரங்கள், இணையதளம், விற்பனைக் கருவிகள் மற்றும் உள் அமைப்புகள் எவ்வளவு சிறப்பாக இணைந்து செயல்படுகின்றன என்பதில் தங்கியுள்ளது.<br><br>Cambridge Marketing இந்த செயல்பாடுகளை ஒரே இணைக்கப்பட்ட சூழலமைப்பில் கொண்டு வருகிறது. சரியான பார்வையாளர்களை ஈர்ப்பது முதல் வாய்ப்புகளை மாற்றுதல், விற்பனையை நிர்வகித்தல், பணிப்பாய்வுகளை தானியக்கமாக்குதல் மற்றும் செயல்திறனை கண்காணித்தல் வரை, ஒவ்வொரு பகுதியும் ஒரே வணிக நோக்கத்தை ஆதரிக்க வடிவமைக்கப்பட்டுள்ளது.',
    'ai.feature1Title': 'பிராண்டு உத்தி மற்றும் படைப்பாற்றல் வழிகாட்டுதல்', 'ai.feature1Desc': 'உங்கள் வணிகம் அறியப்படும் விதத்தை வலுப்படுத்தும் மூலோபாய பிரச்சாரங்கள், சீரான உள்ளடக்கம் மற்றும் தொழில்முறை படைப்பாற்றலால் ஆதரிக்கப்படும் தெளிவான பிராண்டு அமைப்பு.',
    'ai.feature2Title': 'சமூக ஊடகம் மற்றும் செயல்திறன் விளம்பரம்', 'ai.feature2Desc': 'பொருத்தமான பார்வையாளர்களை அடைந்து தகுதியான வாய்ப்புகளை உருவாக்குவதில் கவனம் செலுத்தும் Meta, TikTok மற்றும் Google தளங்களிலான நோக்கமுள்ள உள்ளடக்கம் மற்றும் இலக்கு பிரச்சாரங்கள்.',
    'ai.feature3Title': 'இணையதளங்கள் மற்றும் மாற்ற அனுபவங்கள்', 'ai.feature3Desc': 'மதிப்பை தெளிவாக தெரிவித்து, பார்வையாளர்களை விசாரணைகள், முன்பதிவுகள் அல்லது வாங்குதல்களுக்கு வழிநடத்தும் வேகமான, நம்பகமான இணையதளங்கள் மற்றும் லேண்டிங் பக்கங்கள்.',
    'ai.feature4Title': 'POS மற்றும் ERP தீர்வுகள்', 'ai.feature4Desc': 'பில்லிங், இருப்பு, விற்பனை, அறிக்கைகள் மற்றும் செயல்பாடுகளை இணைத்து, உங்கள் அணிக்கு அதிக கட்டுப்பாட்டை அளித்து துண்டிக்கப்பட்ட செயல்முறைகளை குறைக்கும் தனிப்பயன் அமைப்புகள்.',
    'ai.feature5Title': 'AI தானியக்கம் மற்றும் வாய்ப்பு மேலாண்மை', 'ai.feature5Desc': 'பதில் நேரத்தை மேம்படுத்தி வாய்ப்புகளை தொடர்ந்து நகர்த்தும் தானியங்கி வாய்ப்பு சேகரிப்பு, பின்தொடர்தல்கள், வாடிக்கையாளர் பயணங்கள் மற்றும் வழக்கமான பணிப்பாய்வுகள்.',
    'ai.feature6Title': 'அறிக்கைகள் மற்றும் வணிக நுண்ணறிவு', 'ai.feature6Desc': 'சந்தைப்படுத்தல், வாய்ப்புகள், விற்பனை மற்றும் செயல்பாடுகள் முழுவதும் தெளிவான செயல்திறன் நுண்ணறிவுகள், எது செயல்படுகிறது என்பதை கண்டறிந்து சிறந்த முடிவுகளை எடுக்க உதவுகின்றன.',
    ...
    'comparison.title': 'உள்நிறுவன ஆட்சேர்ப்பா அல்லது பாரம்பரிய அவுட்சோர்சிங்கா?<br><em>இரண்டுமே இல்லை</em>',
    'comparison.supporting': 'தனித்தனி நபர்கள், தளங்கள் மற்றும் வழங்குநர்களை நிர்வகிப்பதற்குப் பதிலாக ஒருங்கிணைந்த வளர்ச்சி அமைப்பை உருவாக்குங்கள்',
    'comparison.requirement': 'உங்கள் வணிகத்திற்குத் தேவையானவை', 'comparison.hiringInHouse': 'உள்நிறுவன ஆட்சேர்ப்பு',
    'comparison.traditionalOutsourcing': 'பாரம்பரிய அவுட்சோர்சிங்', 'comparison.cambm': 'கேம்ப்ரிட்ஜ் மார்க்கெட்டிங்',
    'comparison.strategy': 'வளர்ச்சி உத்தி', 'comparison.strategyInHouse': 'அனுபவமிக்க மூத்த திறனும் உள் மேலாண்மையும் தேவை',
    'comparison.strategyOutsourcing': 'வழங்குநர்களிடையே உத்தி சிதறக்கூடும்', 'comparison.strategyCambm': 'சந்தைப்படுத்தல், தொழில்நுட்பம் மற்றும் செயல்பாடுகளை இணைக்கும் ஒரே வளர்ச்சி உத்தி',
    'comparison.creative': 'படைப்பாற்றல் மற்றும் உள்ளடக்கம்', 'comparison.creativeInHouse': 'வடிவமைப்பாளர்கள், தொகுப்பாளர்கள் மற்றும் உள்ளடக்க நிபுணர்கள் தேவை',
    'comparison.creativeOutsourcing': 'பொதுவாக கோரிக்கை வாரியாக வழங்கப்படுகிறது', 'comparison.creativeCambm': 'பிரச்சாரங்கள் மற்றும் வணிக நோக்கங்களைச் சுற்றி திட்டமிடப்பட்ட படைப்பாற்றல்',
    'comparison.metaAds': 'Meta மற்றும் TikTok விளம்பரங்கள்', 'comparison.metaAdsInHouse': 'அர்ப்பணிக்கப்பட்ட செயல்திறன் நிபுணத்துவம் தேவை',
    'comparison.metaAdsOutsourcing': 'படைப்பாற்றல் மற்றும் உத்தியிலிருந்து தனியாக நிர்வகிக்கப்படுகிறது', 'comparison.metaAdsCambm': 'பிரச்சாரங்கள், படைப்பாற்றல் மற்றும் மேம்படுத்தல் ஒரே அமைப்பாக நிர்வகிக்கப்படுகிறது',
    'comparison.googleAds': 'Google விளம்பரங்கள்', 'comparison.googleAdsInHouse': 'சிறப்பு தேடல் மற்றும் மாற்ற நிபுணத்துவம் தேவை',
    'comparison.googleAdsOutsourcing': 'பொதுவாக மற்றொரு நிபுணர் அல்லது ஏஜென்சி தேவை', 'comparison.googleAdsCambm': 'தேடல், செயல்திறன் மற்றும் லேண்டிங் பக்கங்கள் மாற்றங்களுக்கு ஏற்ப சீரமைக்கப்படுகின்றன',
    'comparison.website': 'இணையதளம் மற்றும் மின்வணிகம்', 'comparison.websiteInHouse': 'மேம்பாடு, பராமரிப்பு மற்றும் சந்தைப்படுத்தல் ஒருங்கிணைப்பு தேவை',
    'comparison.websiteOutsourcing': 'இணையதளமும் சந்தைப்படுத்தலும் பெரும்பாலும் தனித்தனியாக நிர்வகிக்கப்படுகின்றன', 'comparison.websiteCambm': 'சந்தைப்படுத்தல், விற்பனை மற்றும் செயல்பாடுகளை ஆதரிக்கும் இணையதளங்கள் மற்றும் மின்வணிகம்',
    'comparison.posSoftware': 'POS மென்பொருள்', 'comparison.posSoftwareInHouse': 'தனி மென்பொருள் வழங்குநரும் செயல்படுத்தும் குழுவும் தேவை',
    'comparison.posSoftwareOutsourcing': 'உங்கள் இணையதளம் மற்றும் சந்தைப்படுத்தலிலிருந்து பெரும்பாலும் துண்டிக்கப்பட்டுள்ளது', 'comparison.posSoftwareCambm': 'மின்வணிகம், இருப்பு மற்றும் வணிக பணிப்பாய்வுகளுடன் இணைக்கப்பட்ட தனிப்பயன் POS அமைப்புகள்',
    'comparison.erp': 'ERP மற்றும் வணிக அமைப்புகள்', 'comparison.erpInHouse': 'உள்நாட்டில் உருவாக்கவும் பராமரிக்கவும் செலவு அதிகம்',
    'comparison.erpOutsourcing': 'பொதுவாக தனித்த அமைப்பாக செயல்படுத்தப்படுகிறது', 'comparison.erpCambm': 'ERP, POS, இணையதளம் மற்றும் செயல்பாட்டு அமைப்புகள் ஒன்றாக வேலை செய்ய வடிவமைக்கப்பட்டுள்ளன',
    'comparison.aiAutomation': 'AI தானியக்கங்கள் மற்றும் முகவர்கள்', 'comparison.aiAutomationInHouse': 'சிறப்பு AI மற்றும் தானியக்க திறமை தேவை',
    'comparison.aiAutomationOutsourcing': 'தனிமைப்படுத்தப்பட்ட கருவிகளாக பெரும்பாலும் சேர்க்கப்படுகின்றன', 'comparison.aiAutomationCambm': 'விற்பனை, ஆதரவு, சந்தைப்படுத்தல் மற்றும் செயல்பாடுகளில் ஒருங்கிணைக்கப்பட்ட AI முகவர்கள் மற்றும் தானியக்கங்கள்',
    'comparison.reporting': 'அறிக்கைகள் மற்றும் தரவு', 'comparison.reportingInHouse': 'தரவு வெவ்வேறு அணிகள் மற்றும் தளங்களில் சிதறியுள்ளது',
    'comparison.reportingOutsourcing': 'பல வழங்குநர்களிடமிருந்து அறிக்கைகள் வருகின்றன', 'comparison.reportingCambm': 'சந்தைப்படுத்தல், விற்பனை மற்றும் செயல்பாட்டு தரவு ஒரே தெளிவான பார்வையில் கொண்டுவரப்படுகிறது',
    'comparison.management': 'மேலாண்மை மற்றும் பொறுப்புக்கூறல்', 'comparison.managementInHouse': 'நீங்கள் அனைவரையும் ஆட்சேர்ப்பு செய்து, விளக்கி, நிர்வகிக்கிறீர்கள்',
    'comparison.managementOutsourcing': 'பல ஏஜென்சிகள் மற்றும் வழங்குநர்களை நீங்கள் ஒருங்கிணைக்கிறீர்கள்', 'comparison.managementCambm': 'ஒரே கூட்டாளர். ஒரே பணிப்பாய்வு. ஒரே பொறுப்புள்ள அணி.',
    'comparison.conclusion': 'உங்கள் விளம்பரங்கள் உங்கள் இணையதளத்துடன் பேச வேண்டும். உங்கள் இணையதளம் உங்கள் POS உடன் பேச வேண்டும்.<br>உங்கள் POS உங்கள் இருப்புடன் பேச வேண்டும். அடுத்து என்ன நடக்க வேண்டும் என்பதை உங்கள் தரவு தீர்மானிக்க வேண்டும்.',
    'comparison.integratedGrowth': 'ஒருங்கிணைந்த வளர்ச்சி என்று நாங்கள் குறிப்பிடுவது இதுதான்',
    ...
    'footer.office.label': 'எங்கள் அலுவலகங்கள்', 'footer.office.phone': 'தொடர்பு எண்', 'footer.office.address': 'முகவரி', 'footer.office.email': 'மின்னஞ்சல்',
    'footer.office.sa.title': 'Cambridge Marketing - சவுதி அரேபியா', 'footer.office.sa.address': 'City Centre, Mishrifah, Jeddah, சவுதி அரேபியா',
    'footer.office.lk.title': 'Cambridge Marketing - இலங்கை', 'footer.office.lk.address': '328/3 Temple Road, Kaduwela Road, Battaramulla, Colombo, Sri Lanka 10120',
    ...
    'contact.quickActions': 'விரைவு தொடர்பு', 'contact.whatsappAria': 'WhatsApp மூலம் உரையாடுங்கள்', 'contact.callAria': 'Cambridge Marketing-ஐ அழைக்கவும்',
  ...
  Object.assign(TRANSLATIONS.es, {
    ...
    'packages.grow.elite.f13': 'Seguimiento de conversiones y optimización del rendimiento',
    'packages.grow.elite.f14': 'Optimización continua de campañas',
    'packages.grow.elite.f15': 'Informes avanzados de rendimiento y crecimiento',
  ...
  Object.assign(TRANSLATIONS.ta, {
    ...
    'packages.grow.elite.f3': 'மேம்பட்ட பிராண்ட் மற்றும் சந்தைப்படுத்தல் வழிகாட்டுதல்',
    ...
    'packages.grow.elite.f13': 'மாற்று கண்காணிப்பு மற்றும் செயல்திறன் மேம்படுத்தல்',
    'packages.grow.elite.f14': 'தொடர்ச்சியான பிரச்சார மேம்படுத்தல்',
    'packages.grow.elite.f15': 'மேம்பட்ட செயல்திறன் மற்றும் வளர்ச்சி அறிக்கைகள்',
  ...
  Object.assign(TRANSLATIONS.en, {
    ...
    'construction.metaTitle': 'Portfolio Under Construction | Cambridge Marketing',
    'construction.metaDescription': 'Our portfolio is being updated. Return soon to explore selected Cambridge Marketing work and case studies.',
    'construction.title': 'Our portfolio is being rebuilt.',
    'construction.body': 'We’re preparing a clearer view of our selected work and case studies. It will be available soon.',
    ...
    'portfolio.metaDescription': 'Explore selected Cambridge Marketing brand, website, campaign, automation and growth-system case studies.',
    'portfolio.hero.eyebrow': 'Selected Work',
    'portfolio.hero.count': '08 Projects',
    'portfolio.hero.title': 'PORTFOLIO',
    'portfolio.hero.intro': 'An atlas of brands, platforms and growth systems shaped across markets.',
    'portfolio.hero.explore': 'Explore the atlas',
    'portfolio.atlas.eyebrow': 'Project Atlas',
    'portfolio.atlas.title': 'Selected case files',
    'portfolio.atlas.intro': 'Filter by capability, then open any project for the complete case-study view.',
    ...
    'portfolio.empty.body': 'Try another capability or clear the active filters.',
    'portfolio.empty.clear': 'Clear filters',
    'portfolio.unavailable.title': 'The project atlas is temporarily unavailable.',
    'portfolio.unavailable.body': 'Please refresh the page or contact our team to explore the work.',
    'portfolio.image.placeholder': 'Image placeholder',
    'portfolio.image.coverLabel': '{brand} cover image placeholder',
    'portfolio.image.galleryLabel': '{brand} gallery image {number} placeholder',
    ...
    'portfolio.map.intro': 'Choose a country to move closer, then select a city marker to open its project.',
    ...
    'portfolio.map.svgDesc': 'Countries with Cambridge Marketing projects are marked in orange.',
    'portfolio.map.countryMarker': '{country}, {count} projects. Open country view.',
    'portfolio.map.countryMarkerOne': '{country}, 1 project. Open country view.',
    'portfolio.map.projectMarker': '{brand} in {location}. Open project preview.',
    'portfolio.map.zoomingStatus': 'Moving closer to {country}.',
    'portfolio.map.countryStatus': '{country} view. Choose a project marker.',
    'portfolio.map.selectedStatus': '{brand} selected. Project preview is open.',
    'portfolio.map.viewCase': 'View case study',
    'portfolio.cta.eyebrow': 'Start a new coordinate',
    'portfolio.cta.title': 'Have a project in mind?',
    'portfolio.cta.body': 'Let’s map the clearest path from where your brand is now to where it should go next.',
    'portfolio.cta.button': 'Book a strategy call',
    'portfolio.project.myra.teaser': 'A refined beauty identity built to feel editorial, contemporary and unmistakably premium.',
    'portfolio.project.myra.overview': 'A connected brand and campaign direction designed to make Myra feel coherent across every customer touchpoint while creating a stronger platform for future growth.',
    'portfolio.project.myra.challenge': 'The brand needed a clearer visual world and a repeatable social system that could protect its premium position without becoming distant or predictable.',
    'portfolio.project.myra.approach': 'We shaped an editorial identity, modular content language and campaign rhythm that lets every launch feel distinctive while remaining recognisably Myra.',
    'portfolio.project.myra.deliverables': 'Brand direction, social design system, campaign concepts, launch toolkit and performance-ready creative templates.',
    'portfolio.project.hijaz.teaser': 'A food brand system that turns everyday familiarity into confident shelf and social recognition.',
    'portfolio.project.hijaz.overview': 'A focused brand and communication framework that gives Hijaz a consistent voice across product stories, promotions and social campaigns.',
    'portfolio.project.hijaz.challenge': 'A growing product range needed one recognisable story that could remain clear across formats, audiences and fast-moving promotional cycles.',
    'portfolio.project.hijaz.approach': 'We paired strong product cues with a flexible campaign grammar, making the brand easier to recognise and simpler to scale month after month.',
    'portfolio.project.hijaz.deliverables': 'Campaign identity, content pillars, social templates, product storytelling and promotional creative direction.',
    'portfolio.project.uneeflow.teaser': 'A digital platform and automation layer designed to make a technical offer feel direct and effortless.',
    'portfolio.project.uneeflow.overview': 'A systems-led digital experience connecting a clearer website journey with practical automation behind every enquiry and handoff.',
    'portfolio.project.uneeflow.challenge': 'Complex capabilities had to be communicated simply while reducing the manual steps between initial interest and a useful commercial conversation.',
    'portfolio.project.uneeflow.approach': 'We organised the offer around customer intent, then mapped structured conversion paths and automated workflows around the moments that matter.',
    'portfolio.project.uneeflow.deliverables': 'Website architecture, interface direction, conversion journeys, automation flows and system handoff planning.',
    'portfolio.project.alFakhir.teaser': 'A hospitality brand presence shaped around warmth, atmosphere and memorable campaign moments.',
    'portfolio.project.alFakhir.overview': 'A premium content and campaign system that translates the Al Fakhir experience into a consistent visual invitation across digital channels.',
    'portfolio.project.alFakhir.challenge': 'The physical experience carried character, but the digital brand needed a stronger mood and clearer rhythm to create the same sense of anticipation.',
    'portfolio.project.alFakhir.approach': 'We built a sensory visual direction, recurring story formats and campaign moments that balance exclusivity with a welcoming personality.',
    'portfolio.project.alFakhir.deliverables': 'Creative direction, campaign concepts, social content system, promotional toolkit and visual brand guidance.',
    'portfolio.project.mahanama.teaser': 'A modern education platform that brings institutional trust and digital clarity into one journey.',
    'portfolio.project.mahanama.overview': 'A structured web and campaign direction designed to make information easier to navigate while presenting the institution with confidence and relevance.',
    'portfolio.project.mahanama.challenge': 'Different audiences needed quick access to important information without losing the history, trust and human character behind the institution.',
    'portfolio.project.mahanama.approach': 'We created a clear information hierarchy, contemporary visual language and campaign framework built around the needs of students and families.',
    'portfolio.project.mahanama.deliverables': 'Website strategy, information architecture, brand refinement, campaign toolkit and responsive interface direction.',
    'portfolio.project.luckyDarbar.teaser': 'A lively food identity designed to translate flavour, energy and hospitality into every campaign.',
    'portfolio.project.luckyDarbar.overview': 'A recognisable creative system that gives Lucky Darbar the speed to promote offers while keeping every message connected to one energetic brand world.',
    'portfolio.project.luckyDarbar.challenge': 'Frequent promotions risked feeling disconnected, making it harder for audiences to recognise the brand before reading the offer itself.',
    'portfolio.project.luckyDarbar.approach': 'We developed bold visual anchors, repeatable content structures and campaign templates built for pace without sacrificing consistency.',
    'portfolio.project.luckyDarbar.deliverables': 'Brand expression, promotional campaign system, social templates, offer creative and monthly content direction.',
    'portfolio.project.craneShoes.teaser': 'A retail experience connecting product confidence, clear discovery and a stronger digital brand.',
    'portfolio.project.craneShoes.overview': 'A website and brand framework designed to help customers discover products quickly while giving Crane Shoes a more distinctive retail presence.',
    'portfolio.project.craneShoes.challenge': 'The product range needed a clearer digital hierarchy and a visual system able to support both practical shopping decisions and brand aspiration.',
    'portfolio.project.craneShoes.approach': 'We prioritised intuitive discovery, confident product framing and a flexible social language that can move with seasonal retail needs.',
    'portfolio.project.craneShoes.deliverables': 'Website direction, product discovery system, brand refinement, social toolkit and retail campaign templates.',
    'portfolio.project.flyBagdad.teaser': 'A digital journey that makes travel discovery feel clearer, faster and ready for action.',
    'portfolio.project.flyBagdad.overview': 'A conversion-focused web and campaign direction connecting destination discovery with a smoother path from interest to enquiry.',
    'portfolio.project.flyBagdad.challenge': 'Travel choices had to feel inspiring without overwhelming customers, while operational follow-ups needed less manual friction.',
    'portfolio.project.flyBagdad.approach': 'We simplified the journey around destination intent, introduced clear campaign pathways and mapped automation around high-value enquiries.',
    'portfolio.project.flyBagdad.deliverables': 'Website journey, campaign landing system, destination content framework, enquiry automation and conversion creative.',
  });

  Object.assign(TRANSLATIONS.es, {
    'nav.portfolio': 'Portafolio',
    'construction.metaTitle': 'Portafolio en construcción | Cambridge Marketing',
    'construction.metaDescription': 'Estamos actualizando nuestro portafolio. Vuelve pronto para explorar trabajos y casos seleccionados de Cambridge Marketing.',
    'construction.title': 'Estamos renovando nuestro portafolio.',
    'construction.body': 'Estamos preparando una presentación más clara de nuestros trabajos y casos seleccionados. Estará disponible pronto.',
    ...
    'portfolio.metaDescription': 'Explora casos seleccionados de marca, web, campañas, automatización y sistemas de crecimiento de Cambridge Marketing.',
    'portfolio.hero.eyebrow': 'Trabajo seleccionado',
    'portfolio.hero.count': '08 Proyectos',
    'portfolio.hero.title': 'PORTAFOLIO',
    'portfolio.hero.intro': 'Un atlas de marcas, plataformas y sistemas de crecimiento creados para distintos mercados.',
    ...
    'portfolio.atlas.intro': 'Filtra por capacidad y abre cualquier proyecto para ver el caso completo.',
    ...
    'portfolio.empty.body': 'Prueba otra capacidad o elimina los filtros activos.',
    'portfolio.empty.clear': 'Limpiar filtros',
    'portfolio.unavailable.title': 'El atlas de proyectos no está disponible temporalmente.',
    'portfolio.unavailable.body': 'Actualiza la página o contacta con nuestro equipo para explorar el trabajo.',
    ...
    'portfolio.map.intro': 'Elige un país para acercarte y después selecciona una ciudad para abrir su proyecto.',
    ...
    'portfolio.map.svgDesc': 'Los países con proyectos de Cambridge Marketing están marcados en naranja.',
    'portfolio.map.countryMarker': '{country}, {count} proyectos. Abrir vista del país.',
    'portfolio.map.countryMarkerOne': '{country}, 1 proyecto. Abrir vista del país.',
    ...
    'portfolio.map.selectedStatus': '{brand} seleccionado. La vista previa está abierta.',
    'portfolio.map.viewCase': 'Ver caso',
    'portfolio.cta.eyebrow': 'Inicia una nueva coordenada',
    'portfolio.cta.title': '¿Tienes un proyecto en mente?',
    'portfolio.cta.body': 'Tracemos el camino más claro desde donde está tu marca hasta donde debería llegar.',
    'portfolio.cta.button': 'Reservar una llamada estratégica',
    'portfolio.project.myra.teaser': 'Una identidad de belleza refinada, editorial, contemporánea e inconfundiblemente premium.',
    'portfolio.project.myra.overview': 'Una dirección conectada de marca y campaña para dar coherencia a cada punto de contacto de Myra y crear una base sólida para crecer.',
    'portfolio.project.myra.challenge': 'La marca necesitaba un mundo visual más claro y un sistema social repetible que protegiera su posición premium sin volverse distante.',
    'portfolio.project.myra.approach': 'Creamos una identidad editorial, un lenguaje modular y un ritmo de campaña que hace cada lanzamiento distintivo y reconocible.',
    'portfolio.project.myra.deliverables': 'Dirección de marca, sistema social, conceptos de campaña, kit de lanzamiento y plantillas creativas.',
    'portfolio.project.hijaz.teaser': 'Un sistema de marca alimentaria que convierte lo cotidiano en reconocimiento seguro.',
    'portfolio.project.hijaz.overview': 'Un marco de marca y comunicación que ofrece a Hijaz una voz coherente en productos, promociones y campañas sociales.',
    'portfolio.project.hijaz.challenge': 'Una gama creciente necesitaba una historia reconocible que funcionara en múltiples formatos y ciclos promocionales rápidos.',
    'portfolio.project.hijaz.approach': 'Combinamos señales de producto fuertes con una gramática flexible para facilitar el reconocimiento y la expansión.',
    'portfolio.project.hijaz.deliverables': 'Identidad de campaña, pilares de contenido, plantillas sociales, historias de producto y dirección promocional.',
    'portfolio.project.uneeflow.teaser': 'Una plataforma digital y capa de automatización que hace simple una oferta técnica.',
    'portfolio.project.uneeflow.overview': 'Una experiencia digital basada en sistemas que conecta un recorrido web claro con automatización práctica para cada consulta.',
    'portfolio.project.uneeflow.challenge': 'Había que explicar capacidades complejas con sencillez y reducir los pasos manuales entre interés y conversación comercial.',
    'portfolio.project.uneeflow.approach': 'Organizamos la oferta según la intención del cliente y diseñamos rutas de conversión y flujos automatizados.',
    'portfolio.project.uneeflow.deliverables': 'Arquitectura web, dirección de interfaz, recorridos de conversión, automatizaciones y planificación de sistemas.',
    'portfolio.project.alFakhir.teaser': 'Una presencia hotelera construida alrededor de calidez, ambiente y campañas memorables.',
    'portfolio.project.alFakhir.overview': 'Un sistema premium de contenido y campañas que traduce la experiencia Al Fakhir en una invitación visual consistente.',
    'portfolio.project.alFakhir.challenge': 'La experiencia física tenía carácter, pero la marca digital necesitaba más atmósfera y un ritmo claro.',
    'portfolio.project.alFakhir.approach': 'Creamos una dirección sensorial, formatos recurrentes y campañas que equilibran exclusividad y cercanía.',
    'portfolio.project.alFakhir.deliverables': 'Dirección creativa, conceptos de campaña, sistema social, kit promocional y guía visual.',
    'portfolio.project.mahanama.teaser': 'Una plataforma educativa moderna que une confianza institucional y claridad digital.',
    'portfolio.project.mahanama.overview': 'Una dirección web y de campaña para facilitar la navegación y presentar la institución con confianza y relevancia.',
    'portfolio.project.mahanama.challenge': 'Distintos públicos necesitaban información rápida sin perder la historia y el carácter humano de la institución.',
    'portfolio.project.mahanama.approach': 'Creamos una jerarquía clara, un lenguaje contemporáneo y un marco centrado en estudiantes y familias.',
    'portfolio.project.mahanama.deliverables': 'Estrategia web, arquitectura de información, refinamiento de marca, kit de campaña e interfaz responsive.',
    'portfolio.project.luckyDarbar.teaser': 'Una identidad gastronómica viva que transmite sabor, energía y hospitalidad.',
    'portfolio.project.luckyDarbar.overview': 'Un sistema creativo reconocible que permite promocionar ofertas con rapidez dentro de un mismo universo de marca.',
    'portfolio.project.luckyDarbar.challenge': 'Las promociones frecuentes podían sentirse desconectadas y dificultar el reconocimiento inmediato de la marca.',
    'portfolio.project.luckyDarbar.approach': 'Desarrollamos anclas visuales, estructuras repetibles y plantillas rápidas sin sacrificar consistencia.',
    'portfolio.project.luckyDarbar.deliverables': 'Expresión de marca, sistema promocional, plantillas sociales, creatividades de oferta y dirección mensual.',
    'portfolio.project.craneShoes.teaser': 'Una experiencia retail que conecta producto, descubrimiento claro y una marca digital más fuerte.',
    'portfolio.project.craneShoes.overview': 'Un marco web y de marca que ayuda a descubrir productos con rapidez y da a Crane Shoes una presencia distintiva.',
    'portfolio.project.craneShoes.challenge': 'La gama necesitaba una jerarquía digital clara y un sistema visual práctico y aspiracional.',
    'portfolio.project.craneShoes.approach': 'Priorizamos el descubrimiento intuitivo, una presentación segura y un lenguaje social flexible para cada temporada.',
    'portfolio.project.craneShoes.deliverables': 'Dirección web, sistema de descubrimiento, refinamiento de marca, kit social y plantillas retail.',
    'portfolio.project.flyBagdad.teaser': 'Un recorrido digital que hace el descubrimiento de viajes más claro, rápido y accionable.',
    'portfolio.project.flyBagdad.overview': 'Una dirección web y de campañas centrada en conversión que une destinos con un camino más fluido hacia la consulta.',
    'portfolio.project.flyBagdad.challenge': 'Las opciones debían inspirar sin abrumar y los seguimientos operativos necesitaban menos trabajo manual.',
    'portfolio.project.flyBagdad.approach': 'Simplificamos el recorrido por intención, creamos rutas de campaña claras y automatizamos consultas de alto valor.',
    'portfolio.project.flyBagdad.deliverables': 'Recorrido web, landings de campaña, contenido de destinos, automatización de consultas y creatividad de conversión.',
  });

  Object.assign(TRANSLATIONS.ar, {
    'nav.portfolio': 'الأعمال',
    'construction.metaTitle': 'معرض الأعمال قيد الإنشاء | Cambridge Marketing',
    'construction.metaDescription': 'نعمل على تحديث معرض أعمالنا. عُد قريبًا لاستكشاف أعمال ودراسات حالة مختارة من كامبريدج ماركتنج.',
    'construction.title': 'نعيد بناء معرض أعمالنا.',
    'construction.body': 'نُعد عرضًا أوضح لأعمالنا المختارة ودراسات الحالة. سيكون متاحًا قريبًا.',
    ...
    'portfolio.metaDescription': 'استكشف دراسات مختارة للعلامات والمواقع والحملات والأتمتة وأنظمة النمو من كامبريدج للتسويق.',
    'portfolio.hero.eyebrow': 'أعمال مختارة',
    'portfolio.hero.count': '08 مشاريع',
    'portfolio.hero.title': 'أعمالنا',
    'portfolio.hero.intro': 'أطلس للعلامات والمنصات وأنظمة النمو التي صممناها عبر أسواق متعددة.',
    'portfolio.hero.explore': 'استكشف الأطلس',
    'portfolio.atlas.eyebrow': 'أطلس المشاريع',
    'portfolio.atlas.title': 'دراسات حالة مختارة',
    'portfolio.atlas.intro': 'صفِّ المشاريع حسب الخدمة، ثم افتح أي مشروع للاطلاع على دراسة الحالة الكاملة.',
    ...
    'portfolio.unavailable.body': 'يرجى تحديث الصفحة أو التواصل مع فريقنا لاستعراض الأعمال.',
    ...
    'portfolio.map.intro': 'اختر دولة للاقتراب منها، ثم حدد علامة مدينة لفتح مشروعها.',
    ...
    'portfolio.map.svgDesc': 'الدول التي تضم مشاريع كامبريدج للتسويق محددة باللون البرتقالي.',
    'portfolio.map.countryMarker': '{country}، {count} مشاريع. افتح عرض الدولة.',
    'portfolio.map.countryMarkerOne': '{country}، مشروع واحد. افتح عرض الدولة.',
    'portfolio.map.projectMarker': '{brand} في {location}. افتح معاينة المشروع.',
    ...
    'portfolio.cta.eyebrow': 'ابدأ إحداثية جديدة',
    'portfolio.cta.title': 'لديك مشروع في ذهنك؟',
    'portfolio.cta.body': 'لنرسم أوضح مسار من موقع علامتك اليوم إلى المكان الذي ينبغي أن تصل إليه.',
    'portfolio.cta.button': 'احجز مكالمة استراتيجية',
    'portfolio.project.myra.teaser': 'هوية جمالية راقية بطابع تحريري معاصر وحضور فاخر واضح.',
    'portfolio.project.myra.overview': 'توجه متكامل للعلامة والحملات يمنح Myra اتساقاً في كل نقطة تواصل ويبني أساساً أقوى للنمو.',
    'portfolio.project.myra.challenge': 'احتاجت العلامة إلى عالم بصري أوضح ونظام اجتماعي قابل للتكرار يحمي مكانتها الفاخرة دون أن يبدو بعيداً.',
    'portfolio.project.myra.approach': 'صممنا هوية تحريرية ولغة محتوى مرنة وإيقاع حملات يجعل كل إطلاق مميزاً ومعروفاً بوضوح.',
    'portfolio.project.myra.deliverables': 'توجه العلامة، نظام المحتوى الاجتماعي، أفكار الحملات، أدوات الإطلاق وقوالب إبداعية.',
    'portfolio.project.hijaz.teaser': 'نظام لعلامة غذائية يحول الألفة اليومية إلى حضور واثق وسهل التذكر.',
    'portfolio.project.hijaz.overview': 'إطار واضح للعلامة والتواصل يمنح Hijaz صوتاً متسقاً عبر المنتجات والعروض والحملات الاجتماعية.',
    'portfolio.project.hijaz.challenge': 'احتاج تنوع المنتجات المتنامي إلى قصة واحدة معروفة تعمل عبر صيغ وجماهير ودورات ترويجية سريعة.',
    'portfolio.project.hijaz.approach': 'جمعنا بين إشارات المنتج القوية وقواعد حملات مرنة لتسهيل التعرف على العلامة وتوسيعها.',
    'portfolio.project.hijaz.deliverables': 'هوية حملات، محاور محتوى، قوالب اجتماعية، قصص منتجات وتوجيه ترويجي.',
    'portfolio.project.uneeflow.teaser': 'منصة رقمية وطبقة أتمتة تجعل العرض التقني واضحاً وسلساً.',
    'portfolio.project.uneeflow.overview': 'تجربة رقمية مبنية على الأنظمة تربط رحلة موقع واضحة بأتمتة عملية لكل استفسار وتسليم.',
    'portfolio.project.uneeflow.challenge': 'كان يجب شرح القدرات المعقدة ببساطة وتقليل الخطوات اليدوية بين الاهتمام والمحادثة التجارية.',
    'portfolio.project.uneeflow.approach': 'نظمنا العرض حسب نية العميل ورسمنا مسارات تحويل وتدفقات مؤتمتة حول اللحظات المهمة.',
    'portfolio.project.uneeflow.deliverables': 'هيكلة الموقع، توجيه الواجهة، رحلات التحويل، تدفقات الأتمتة وتخطيط تكامل الأنظمة.',
    'portfolio.project.alFakhir.teaser': 'حضور ضيافة مبني حول الدفء والأجواء ولحظات الحملات التي لا تُنسى.',
    'portfolio.project.alFakhir.overview': 'نظام محتوى وحملات فاخر يترجم تجربة Al Fakhir إلى دعوة بصرية متسقة عبر القنوات الرقمية.',
    'portfolio.project.alFakhir.challenge': 'حملت التجربة الواقعية طابعاً مميزاً، لكن الحضور الرقمي احتاج إلى أجواء أقوى وإيقاع أوضح.',
    'portfolio.project.alFakhir.approach': 'بنينا توجهاً حسياً وصيغ قصص متكررة وحملات توازن بين التفرد والشخصية المرحبة.',
    'portfolio.project.alFakhir.deliverables': 'توجيه إبداعي، أفكار حملات، نظام محتوى اجتماعي، أدوات ترويجية وإرشادات بصرية.',
    'portfolio.project.mahanama.teaser': 'منصة تعليمية حديثة تجمع الثقة المؤسسية والوضوح الرقمي في رحلة واحدة.',
    'portfolio.project.mahanama.overview': 'توجه للموقع والحملات يسهل الوصول إلى المعلومات ويقدم المؤسسة بثقة وملاءمة معاصرة.',
    'portfolio.project.mahanama.challenge': 'احتاجت جماهير مختلفة إلى المعلومات بسرعة دون فقد تاريخ المؤسسة وثقتها وطابعها الإنساني.',
    'portfolio.project.mahanama.approach': 'أنشأنا هرمية معلومات واضحة ولغة بصرية حديثة وإطار حملات يركز على الطلاب والعائلات.',
    'portfolio.project.mahanama.deliverables': 'استراتيجية موقع، هيكلة معلومات، تطوير العلامة، أدوات حملات وتوجيه واجهة متجاوبة.',
    'portfolio.project.luckyDarbar.teaser': 'هوية غذائية حيوية تنقل النكهة والطاقة والضيافة إلى كل حملة.',
    'portfolio.project.luckyDarbar.overview': 'نظام إبداعي معروف يمنح Lucky Darbar سرعة الترويج مع إبقاء الرسائل ضمن عالم علامة واحد.',
    'portfolio.project.luckyDarbar.challenge': 'هددت كثرة العروض بأن تبدو منفصلة، ما يصعّب التعرف على العلامة قبل قراءة العرض.',
    'portfolio.project.luckyDarbar.approach': 'طورنا ركائز بصرية جريئة وهياكل محتوى متكررة وقوالب سريعة تحافظ على الاتساق.',
    'portfolio.project.luckyDarbar.deliverables': 'تعبير العلامة، نظام حملات ترويجية، قوالب اجتماعية، إبداعات عروض وتوجيه شهري.',
    'portfolio.project.craneShoes.teaser': 'تجربة تجزئة تربط ثقة المنتج بسهولة الاكتشاف وعلامة رقمية أقوى.',
    'portfolio.project.craneShoes.overview': 'إطار للموقع والعلامة يساعد العملاء على اكتشاف المنتجات بسرعة ويمنح Crane Shoes حضوراً مميزاً.',
    'portfolio.project.craneShoes.challenge': 'احتاجت مجموعة المنتجات إلى هرمية رقمية أوضح ونظام بصري يدعم القرار العملي والطموح معاً.',
    'portfolio.project.craneShoes.approach': 'ركزنا على اكتشاف سهل وعرض واثق للمنتج ولغة اجتماعية مرنة تلائم مواسم التجزئة.',
    'portfolio.project.craneShoes.deliverables': 'توجيه الموقع، نظام اكتشاف المنتجات، تطوير العلامة، أدوات اجتماعية وقوالب حملات.',
    'portfolio.project.flyBagdad.teaser': 'رحلة رقمية تجعل اكتشاف السفر أوضح وأسرع وأكثر استعداداً للتنفيذ.',
    'portfolio.project.flyBagdad.overview': 'توجه للموقع والحملات يربط اكتشاف الوجهات بمسار أكثر سلاسة من الاهتمام إلى الاستفسار.',
    'portfolio.project.flyBagdad.challenge': 'كان على خيارات السفر أن تلهم دون إرباك العملاء، مع تقليل العمل اليدوي في المتابعة.',
    'portfolio.project.flyBagdad.approach': 'بسّطنا الرحلة حول نية الوجهة وأنشأنا مسارات حملات واضحة وأتمتة للاستفسارات المهمة.',
    'portfolio.project.flyBagdad.deliverables': 'رحلة الموقع، صفحات حملات، إطار محتوى الوجهات، أتمتة الاستفسارات وإبداع التحويل.',
  });

  Object.assign(TRANSLATIONS.si, {
    'nav.portfolio': 'නිර්මාණ',
    'construction.metaTitle': 'නිර්මාණ එකතුව සකස් කරමින් | Cambridge Marketing',
    'construction.metaDescription': 'අපගේ නිර්මාණ එකතුව යාවත්කාලීන කරමින් පවතී. Cambridge Marketing හි තෝරාගත් වැඩ සහ සිද්ධි අධ්‍යයන බැලීමට නැවත පැමිණෙන්න.',
    'construction.title': 'අපගේ නිර්මාණ එකතුව නැවත සකස් කරමින් පවතී.',
    'construction.body': 'අපගේ තෝරාගත් වැඩ සහ සිද්ධි අධ්‍යයන වඩාත් පැහැදිලිව ඉදිරිපත් කිරීමට අපි සූදානම් වෙමින් සිටිමු. එය ඉක්මනින් ලබා ගත හැකි වනු ඇත.',
    ...
    'portfolio.metaDescription': 'Cambridge Marketing හි තෝරාගත් සන්නාම, වෙබ්, ප්‍රචාරණ, ස්වයංක්‍රීයකරණ සහ වර්ධන පද්ධති අධ්‍යයන බලන්න.',
    'portfolio.hero.eyebrow': 'තෝරාගත් වැඩ',
    'portfolio.hero.count': 'ව්‍යාපෘති 08',
    'portfolio.hero.title': 'නිර්මාණ',
    'portfolio.hero.intro': 'වෙළඳපොළ කිහිපයක් සඳහා නිර්මාණය කළ සන්නාම, වේදිකා සහ වර්ධන පද්ධති සිතියමක්.',
    'portfolio.hero.explore': 'සිතියම බලන්න',
    'portfolio.atlas.eyebrow': 'ව්‍යාපෘති සිතියම',
    'portfolio.atlas.title': 'තෝරාගත් සිද්ධි අධ්‍යයන',
    'portfolio.atlas.intro': 'සේවාව අනුව පෙරහන් කර සම්පූර්ණ අධ්‍යයනය සඳහා ඕනෑම ව්‍යාපෘතියක් විවෘත කරන්න.',
    ...
    'portfolio.empty.body': 'වෙනත් සේවාවක් තෝරන්න හෝ සක්‍රීය පෙරහන් ඉවත් කරන්න.',
    'portfolio.empty.clear': 'පෙරහන් ඉවත් කරන්න',
    'portfolio.unavailable.title': 'ව්‍යාපෘති සිතියම තාවකාලිකව ලබාගත නොහැක.',
    'portfolio.unavailable.body': 'පිටුව නැවත පූරණය කරන්න හෝ අපගේ කණ්ඩායම අමතන්න.',
    ...
    'portfolio.map.intro': 'රටක් තෝරා සමීප වන්න, පසුව එහි ව්‍යාපෘතිය බැලීමට නගර ලකුණක් තෝරන්න.',
    ...
    'portfolio.map.svgDesc': 'Cambridge Marketing ව්‍යාපෘති ඇති රටවල් තැඹිලි පැහැයෙන් ලකුණු කර ඇත.',
    'portfolio.map.countryMarker': '{country}, ව්‍යාපෘති {count}. රටේ දසුන විවෘත කරන්න.',
    'portfolio.map.countryMarkerOne': '{country}, ව්‍යාපෘතියක්. රටේ දසුන විවෘත කරන්න.',
    'portfolio.map.projectMarker': '{location} හි {brand}. ව්‍යාපෘති පෙරදසුන විවෘත කරන්න.',
    'portfolio.map.zoomingStatus': '{country} වෙත සමීප වෙමින්.',
    'portfolio.map.countryStatus': '{country} දසුන. ව්‍යාපෘති ලකුණක් තෝරන්න.',
    'portfolio.map.selectedStatus': '{brand} තෝරා ඇත. ව්‍යාපෘති පෙරදසුන විවෘතයි.',
    'portfolio.map.viewCase': 'සිද්ධි අධ්‍යයනය බලන්න',
    'portfolio.cta.eyebrow': 'නව ලක්ෂ්‍යයක් අරඹන්න',
    'portfolio.cta.title': 'ඔබට ව්‍යාපෘතියක් සිතේ තිබේද?',
    'portfolio.cta.body': 'ඔබේ සන්නාමය අද සිට එය ළඟා විය යුතු තැනට යන පැහැදිලිම මාර්ගය සකස් කරමු.',
    'portfolio.cta.button': 'උපායමාර්ගික ඇමතුමක් වෙන්කරගන්න',
    'portfolio.project.myra.teaser': 'සංස්කාරකමය, නවීන සහ පැහැදිලිව උසස් පෙනුමක් ඇති රූපලාවණ්‍ය අනන්‍යතාවයක්.',
    'portfolio.project.myra.overview': 'සෑම පාරිභෝගික ස්පර්ශයකදීම Myra එකමුතු කර අනාගත වර්ධනයට ශක්තිමත් පදනමක් දෙන සන්නාම සහ ප්‍රචාරණ දිශාවක්.',
    'portfolio.project.myra.challenge': 'දුරස් නොවී උසස් තත්ත්වය රැකගන්නා පැහැදිලි දෘශ්‍ය ලෝකයක් සහ නැවත භාවිත කළ හැකි සමාජ පද්ධතියක් අවශ්‍ය විය.',
    'portfolio.project.myra.approach': 'සෑම දියත් කිරීමක්ම වෙනස් නමුත් හඳුනාගත හැකි ලෙස සංස්කාරක අනන්‍යතාවයක්, මොඩියුලර් අන්තර්ගත භාෂාවක් සහ ප්‍රචාරණ රිද්මයක් සැකසුවෙමු.',
    'portfolio.project.myra.deliverables': 'සන්නාම දිශාව, සමාජ නිර්මාණ පද්ධතිය, ප්‍රචාරණ සංකල්ප, දියත් කිරීමේ කට්ටලය සහ නිර්මාණ අච්චු.',
    'portfolio.project.hijaz.teaser': 'දෛනික හුරුපුරුදුකම විශ්වාසනීය හඳුනාගැනීමකට පරිවර්තනය කරන ආහාර සන්නාම පද්ධතියක්.',
    'portfolio.project.hijaz.overview': 'නිෂ්පාදන කතා, ප්‍රවර්ධන සහ සමාජ ප්‍රචාරණ පුරා Hijaz සඳහා එකම හඬක් දෙන සන්නාම සහ සන්නිවේදන රාමුවක්.',
    'portfolio.project.hijaz.challenge': 'වේගවත් ප්‍රවර්ධන චක්‍ර සහ විවිධ ආකෘති පුරා හඳුනාගත හැකි එක් කතාවක් වර්ධනය වන නිෂ්පාදන පරාසයට අවශ්‍ය විය.',
    'portfolio.project.hijaz.approach': 'සන්නාමය හඳුනාගැනීම සහ මාසිකව පුළුල් කිරීම පහසු කිරීමට ශක්තිමත් නිෂ්පාදන ලකුණු සහ නම්‍යශීලී ප්‍රචාරණ භාෂාවක් එක් කළෙමු.',
    'portfolio.project.hijaz.deliverables': 'ප්‍රචාරණ අනන්‍යතාව, අන්තර්ගත තීරු, සමාජ අච්චු, නිෂ්පාදන කතා සහ ප්‍රවර්ධන දිශාව.',
    'portfolio.project.uneeflow.teaser': 'තාක්ෂණික පිරිනැමීමක් සෘජු සහ පහසු කරන ඩිජිටල් වේදිකාවක් සහ ස්වයංක්‍රීය පද්ධතියක්.',
    'portfolio.project.uneeflow.overview': 'පැහැදිලි වෙබ් ගමනක් සෑම විමසීමක් පිටුපසම ප්‍රායෝගික ස්වයංක්‍රීයකරණය සමඟ සම්බන්ධ කරන ඩිජිටල් අත්දැකීමක්.',
    'portfolio.project.uneeflow.challenge': 'සංකීර්ණ හැකියාවන් සරලව පැහැදිලි කර ආරම්භක උනන්දුව සහ වාණිජ සංවාදය අතර අතින් කරන පියවර අඩු කළ යුතු විය.',
    'portfolio.project.uneeflow.approach': 'පාරිභෝගික අරමුණ අනුව පිරිනැමීම සකස් කර වැදගත් අවස්ථා වටා පරිවර්තන මාර්ග සහ ස්වයංක්‍රීය ප්‍රවාහ සැලසුම් කළෙමු.',
    'portfolio.project.uneeflow.deliverables': 'වෙබ් ව්‍යුහය, අතුරුමුහුණත් දිශාව, පරිවර්තන ගමන්, ස්වයංක්‍රීය ප්‍රවාහ සහ පද්ධති සැලසුම.',
    'portfolio.project.alFakhir.teaser': 'උණුසුම, වාතාවරණය සහ මතකයේ රැඳෙන ප්‍රචාරණ අවස්ථා වටා ගොඩනැගූ ආගන්තුක සත්කාර සන්නාමයක්.',
    'portfolio.project.alFakhir.overview': 'Al Fakhir අත්දැකීම ඩිජිටල් නාලිකා පුරා එකම දෘශ්‍ය ආරාධනයකට පරිවර්තනය කරන උසස් අන්තර්ගත සහ ප්‍රචාරණ පද්ධතියක්.',
    'portfolio.project.alFakhir.challenge': 'භෞතික අත්දැකීමට චරිතයක් තිබුණත් ඩිජිටල් සන්නාමයට ශක්තිමත් මනෝභාවයක් සහ පැහැදිලි රිද්මයක් අවශ්‍ය විය.',
    'portfolio.project.alFakhir.approach': 'විශේෂත්වය සහ පිළිගැනීම සමබර කරන සංවේදී දෘශ්‍ය දිශාවක්, නැවත භාවිත කතා ආකෘති සහ ප්‍රචාරණ අවස්ථා ගොඩනැගුවෙමු.',
    'portfolio.project.alFakhir.deliverables': 'නිර්මාණ දිශාව, ප්‍රචාරණ සංකල්ප, සමාජ අන්තර්ගත පද්ධතිය, ප්‍රවර්ධන කට්ටලය සහ දෘශ්‍ය මාර්ගෝපදේශ.',
    'portfolio.project.mahanama.teaser': 'ආයතනික විශ්වාසය සහ ඩිජිටල් පැහැදිලිභාවය එකම ගමනකට ගෙන එන නවීන අධ්‍යාපන වේදිකාවක්.',
    'portfolio.project.mahanama.overview': 'තොරතුරු සොයාගැනීම පහසු කර ආයතනය විශ්වාසයෙන් සහ නවීනත්වයෙන් ඉදිරිපත් කරන වෙබ් සහ ප්‍රචාරණ දිශාවක්.',
    'portfolio.project.mahanama.challenge': 'විවිධ ප්‍රේක්ෂකයින්ට ආයතනයේ ඉතිහාසය, විශ්වාසය සහ මානව ස්වභාවය අහිමි නොකර ඉක්මනින් තොරතුරු ලබාගත යුතු විය.',
    'portfolio.project.mahanama.approach': 'ශිෂ්‍යයින් සහ පවුල් කේන්ද්‍ර කර පැහැදිලි තොරතුරු පද්ධතියක්, නවීන දෘශ්‍ය භාෂාවක් සහ ප්‍රචාරණ රාමුවක් නිර්මාණය කළෙමු.',
    'portfolio.project.mahanama.deliverables': 'වෙබ් උපායමාර්ගය, තොරතුරු ව්‍යුහය, සන්නාම සංවර්ධනය, ප්‍රචාරණ කට්ටලය සහ ප්‍රතිචාරී අතුරුමුහුණත.',
    'portfolio.project.luckyDarbar.teaser': 'රසය, ශක්තිය සහ ආගන්තුක සත්කාරය සෑම ප්‍රචාරණයකටම ගෙන යන සජීවී ආහාර අනන්‍යතාවයක්.',
    'portfolio.project.luckyDarbar.overview': 'සෑම පණිවිඩයක්ම එකම සන්නාම ලෝකයක තබමින් Lucky Darbar වෙත වේගයෙන් ප්‍රවර්ධන කිරීමට ඉඩදෙන නිර්මාණ පද්ධතියක්.',
    'portfolio.project.luckyDarbar.challenge': 'නිතර වෙනස් වන ප්‍රවර්ධන එකිනෙකට වෙන්ව පෙනීම නිසා පිරිනැමීම කියවීමට පෙර සන්නාමය හඳුනාගැනීම අපහසු විය.',
    'portfolio.project.luckyDarbar.approach': 'එකමුතුභාවය අහිමි නොකර වේගයෙන් ක්‍රියා කිරීමට දෘශ්‍ය ලකුණු, නැවත භාවිත අන්තර්ගත ව්‍යුහ සහ අච්චු සැකසුවෙමු.',
    'portfolio.project.luckyDarbar.deliverables': 'සන්නාම ප්‍රකාශනය, ප්‍රවර්ධන පද්ධතිය, සමාජ අච්චු, පිරිනැමීම් නිර්මාණ සහ මාසික දිශාව.',
    'portfolio.project.craneShoes.teaser': 'නිෂ්පාදන විශ්වාසය, පහසු සොයාගැනීම සහ ශක්තිමත් ඩිජිටල් සන්නාමයක් සම්බන්ධ කරන සිල්ලර අත්දැකීමක්.',
    'portfolio.project.craneShoes.overview': 'පාරිභෝගිකයින්ට නිෂ්පාදන ඉක්මනින් සොයාගැනීමට සහ Crane Shoes වෙත වෙනස් සිල්ලර පැවැත්මක් දීමට සැලසුම් කළ වෙබ් සහ සන්නාම රාමුවක්.',
    'portfolio.project.craneShoes.challenge': 'නිෂ්පාදන පරාසයට ප්‍රායෝගික තීරණ සහ සන්නාම ආකර්ෂණය දෙකම සහාය වන පැහැදිලි ඩිජිටල් ව්‍යුහයක් අවශ්‍ය විය.',
    'portfolio.project.craneShoes.approach': 'පහසු සොයාගැනීම, විශ්වාසනීය නිෂ්පාදන ඉදිරිපත් කිරීම සහ වාරික අවශ්‍යතා සමඟ ගමන් කරන සමාජ භාෂාවක් ප්‍රමුඛ කළෙමු.',
    'portfolio.project.craneShoes.deliverables': 'වෙබ් දිශාව, නිෂ්පාදන සොයාගැනීමේ පද්ධතිය, සන්නාම සංවර්ධනය, සමාජ කට්ටලය සහ සිල්ලර අච්චු.',
    'portfolio.project.flyBagdad.teaser': 'සංචාර සොයාගැනීම පැහැදිලි, වේගවත් සහ ක්‍රියාත්මක කිරීමට සූදානම් කරන ඩිජිටල් ගමනක්.',
    'portfolio.project.flyBagdad.overview': 'ගමනාන්ත සොයාගැනීම උනන්දුවේ සිට විමසීම දක්වා පහසු මාර්ගයකට සම්බන්ධ කරන වෙබ් සහ ප්‍රචාරණ දිශාවක්.',
    'portfolio.project.flyBagdad.challenge': 'සංචාර තේරීම් පාරිභෝගිකයින් අධික තොරතුරුවලින් වෙහෙස නොකර ආකර්ෂණීය විය යුතු අතර පසු විමසුම් අතින් කිරීම අඩු කළ යුතු විය.',
    'portfolio.project.flyBagdad.approach': 'ගමනාන්ත අරමුණ වටා ගමන සරල කර පැහැදිලි ප්‍රචාරණ මාර්ග සහ වටිනා විමසීම් සඳහා ස්වයංක්‍රීයකරණය සකස් කළෙමු.',
    'portfolio.project.flyBagdad.deliverables': 'වෙබ් ගමන, ප්‍රචාරණ පිටු, ගමනාන්ත අන්තර්ගත රාමුව, විමසීම් ස්වයංක්‍රීයකරණය සහ පරිවර්තන නිර්මාණ.',
  });

  Object.assign(TRANSLATIONS.ta, {
    'nav.portfolio': 'படைப்புகள்',
    'construction.metaTitle': 'படைப்புத் தொகுப்பு உருவாக்கத்தில் | Cambridge Marketing',
    'construction.metaDescription': 'எங்கள் படைப்புத் தொகுப்பு புதுப்பிக்கப்படுகிறது. Cambridge Marketing இன் தேர்ந்தெடுக்கப்பட்ட பணிகள் மற்றும் வழக்குக் குறிப்புகளைப் பார்க்க விரைவில் மீண்டும் வாருங்கள்.',
    'construction.title': 'எங்கள் படைப்புத் தொகுப்பை மீண்டும் உருவாக்குகிறோம்.',
    'construction.body': 'எங்கள் தேர்ந்தெடுக்கப்பட்ட பணிகள் மற்றும் வழக்குக் குறிப்புகளை மேலும் தெளிவாகக் காண்பிக்கத் தயாராகிறோம். இது விரைவில் கிடைக்கும்.',
    ...
    'portfolio.metaDescription': 'Cambridge Marketing உருவாக்கிய தேர்ந்தெடுக்கப்பட்ட பிராண்ட், இணையதளம், பிரச்சாரம், தானியக்கம் மற்றும் வளர்ச்சி அமைப்பு ஆய்வுகளைப் பாருங்கள்.',
    'portfolio.hero.eyebrow': 'தேர்ந்தெடுத்த பணிகள்',
    'portfolio.hero.count': '08 திட்டங்கள்',
    'portfolio.hero.title': 'படைப்புகள்',
    'portfolio.hero.intro': 'பல சந்தைகளுக்காக வடிவமைக்கப்பட்ட பிராண்டுகள், தளங்கள் மற்றும் வளர்ச்சி அமைப்புகளின் அட்லஸ்.',
    ...
    'portfolio.atlas.intro': 'சேவையின்படி வடிகட்டி, முழு ஆய்வைக் காண எந்தத் திட்டத்தையும் திறக்கவும்.',
    ...
    'portfolio.empty.body': 'வேறு சேவையை முயற்சிக்கவும் அல்லது செயலில் உள்ள வடிகட்டிகளை நீக்கவும்.',
    'portfolio.empty.clear': 'வடிகட்டிகளை நீக்கு',
    'portfolio.unavailable.title': 'திட்ட அட்லஸ் தற்காலிகமாக கிடைக்கவில்லை.',
    'portfolio.unavailable.body': 'பக்கத்தைப் புதுப்பிக்கவும் அல்லது பணிகளை அறிய எங்கள் அணியைத் தொடர்புகொள்ளவும்.',
    ...
    'portfolio.case.ctaTitle': 'உங்கள் அடுத்த அத்தியாயத்தை எங்களுடன் உருவாக்குங்கள்.',
    ...
    'portfolio.map.intro': 'ஒரு நாட்டைத் தேர்ந்தெடுத்து நெருங்கி, அதன் திட்டத்தைத் திறக்க நகரக் குறியீட்டைத் தேர்ந்தெடுக்கவும்.',
    'portfolio.map.shortcutAria': 'திட்ட வரைபடத்திற்குச் செல்லவும்',
    'portfolio.map.back': 'திரும்பு',
    'portfolio.map.worldStatus': 'உலகக் காட்சி. திட்டங்கள் உள்ள நாட்டைத் தேர்ந்தெடுக்கவும்.',
    'portfolio.map.svgTitle': 'ஊடாடும் உலகத் திட்ட வரைபடம்',
    'portfolio.map.svgDesc': 'Cambridge Marketing திட்டங்கள் உள்ள நாடுகள் ஆரஞ்சு நிறத்தில் குறிக்கப்பட்டுள்ளன.',
    'portfolio.map.countryMarker': '{country}, {count} திட்டங்கள். நாட்டுக் காட்சியைத் திறக்கவும்.',
    'portfolio.map.countryMarkerOne': '{country}, 1 திட்டம். நாட்டுக் காட்சியைத் திறக்கவும்.',
    'portfolio.map.projectMarker': '{location} இல் {brand}. திட்ட முன்னோட்டத்தைத் திறக்கவும்.',
    'portfolio.map.zoomingStatus': '{country} நோக்கி நெருங்குகிறது.',
    'portfolio.map.countryStatus': '{country} காட்சி. ஒரு திட்டக் குறியீட்டைத் தேர்ந்தெடுக்கவும்.',
    'portfolio.map.selectedStatus': '{brand} தேர்ந்தெடுக்கப்பட்டது. திட்ட முன்னோட்டம் திறந்துள்ளது.',
    'portfolio.map.viewCase': 'வழக்குக் கோப்பைப் பார்க்கவும்',
    'portfolio.cta.eyebrow': 'புதிய இடத்தைத் தொடங்குங்கள்',
    'portfolio.cta.title': 'ஒரு திட்டம் மனதில் உள்ளதா?',
    'portfolio.cta.body': 'உங்கள் பிராண்ட் இன்று இருக்கும் இடத்திலிருந்து அடுத்த இலக்குக்குச் செல்லும் தெளிவான பாதையை வரைபடமாக்குவோம்.',
    'portfolio.cta.button': 'உத்தி அழைப்பை முன்பதிவு செய்யுங்கள்',
    'portfolio.project.myra.teaser': 'தலையங்கத் தன்மை, நவீனம் மற்றும் தெளிவான உயர்தர உணர்வு கொண்ட அழகு அடையாளம்.',
    'portfolio.project.myra.overview': 'ஒவ்வொரு வாடிக்கையாளர் தொடுப்பிலும் Myra-வை ஒருங்கிணைத்து எதிர்கால வளர்ச்சிக்கான வலுவான அடித்தளத்தை உருவாக்கும் பிராண்ட் மற்றும் பிரச்சார திசை.',
    'portfolio.project.myra.challenge': 'தொலைவாகத் தோன்றாமல் உயர்தர நிலையைப் பாதுகாக்கும் தெளிவான காட்சி உலகமும் மீண்டும் பயன்படுத்தக்கூடிய சமூக அமைப்பும் தேவைப்பட்டது.',
    'portfolio.project.myra.approach': 'ஒவ்வொரு வெளியீடும் தனித்துவமாகவும் Myra என அடையாளம் காணக்கூடியதாகவும் இருக்க தலையங்க அடையாளம், நெகிழ்வான உள்ளடக்க மொழி மற்றும் பிரச்சார ஓட்டத்தை உருவாக்கினோம்.',
    'portfolio.project.myra.deliverables': 'பிராண்ட் திசை, சமூக வடிவமைப்பு அமைப்பு, பிரச்சாரக் கருத்துகள், வெளியீட்டுக் கருவிகள் மற்றும் படைப்பாற்றல் வார்ப்புருக்கள்.',
    'portfolio.project.hijaz.teaser': 'அன்றாடப் பரிச்சயத்தை நம்பிக்கையான அடையாளமாக மாற்றும் உணவுப் பிராண்ட் அமைப்பு.',
    'portfolio.project.hijaz.overview': 'தயாரிப்புக் கதைகள், விளம்பரங்கள் மற்றும் சமூகப் பிரச்சாரங்கள் முழுவதும் Hijaz-க்கு ஒரே குரலை வழங்கும் பிராண்ட் மற்றும் தொடர்பு கட்டமைப்பு.',
    'portfolio.project.hijaz.challenge': 'வளரும் தயாரிப்பு வரிசைக்கு பல வடிவங்கள் மற்றும் வேகமான விளம்பரச் சுழற்சிகளில் அடையாளம் காணக்கூடிய ஒரே கதை தேவைப்பட்டது.',
    'portfolio.project.hijaz.approach': 'அடையாளத்தையும் விரிவாக்கத்தையும் எளிதாக்க வலுவான தயாரிப்பு குறியீடுகளையும் நெகிழ்வான பிரச்சார இலக்கணத்தையும் இணைத்தோம்.',
    'portfolio.project.hijaz.deliverables': 'பிரச்சார அடையாளம், உள்ளடக்கத் தூண்கள், சமூக வார்ப்புருக்கள், தயாரிப்புக் கதைகள் மற்றும் விளம்பரத் திசை.',
    'portfolio.project.uneeflow.teaser': 'தொழில்நுட்பச் சேவையை நேரடியும் எளிதுமாக உணரச் செய்யும் டிஜிட்டல் தளம் மற்றும் தானியக்க அடுக்கு.',
    'portfolio.project.uneeflow.overview': 'தெளிவான இணையப் பயணத்தை ஒவ்வொரு விசாரணையின் பின்னுள்ள நடைமுறை தானியக்கத்துடன் இணைக்கும் அமைப்பு சார்ந்த டிஜிட்டல் அனுபவம்.',
    'portfolio.project.uneeflow.challenge': 'சிக்கலான திறன்களை எளிதாக விளக்கி, ஆரம்ப ஆர்வத்துக்கும் வணிக உரையாடலுக்கும் இடையிலான கைமுறை படிகளை குறைக்க வேண்டியது.',
    'portfolio.project.uneeflow.approach': 'வாடிக்கையாளர் நோக்கத்தை மையமாக வைத்து சேவையை ஒழுங்குபடுத்தி முக்கிய தருணங்களுக்கு மாற்றுப் பாதைகளையும் தானியக்க ஓட்டங்களையும் வடிவமைத்தோம்.',
    'portfolio.project.uneeflow.deliverables': 'இணைய கட்டமைப்பு, இடைமுகத் திசை, மாற்றுப் பயணங்கள், தானியக்க ஓட்டங்கள் மற்றும் அமைப்பு இணைப்புத் திட்டம்.',
    'portfolio.project.alFakhir.teaser': 'வெம்மை, சூழல் மற்றும் நினைவில் நிற்கும் பிரச்சாரத் தருணங்களை மையமாகக் கொண்ட விருந்தோம்பல் அடையாளம்.',
    'portfolio.project.alFakhir.overview': 'Al Fakhir அனுபவத்தை டிஜிட்டல் சேனல்களில் ஒரே காட்சி அழைப்பாக மாற்றும் உயர்தர உள்ளடக்க மற்றும் பிரச்சார அமைப்பு.',
    'portfolio.project.alFakhir.challenge': 'நேரடி அனுபவத்தில் தன்மை இருந்தாலும், டிஜிட்டல் பிராண்டுக்கு வலுவான மனநிலையும் தெளிவான ஓட்டமும் தேவைப்பட்டது.',
    'portfolio.project.alFakhir.approach': 'தனித்தன்மையையும் வரவேற்பையும் சமப்படுத்தும் உணர்வுப்பூர்வ காட்சித் திசை, தொடர்ச்சியான கதைகள் மற்றும் பிரச்சாரத் தருணங்களை உருவாக்கினோம்.',
    'portfolio.project.alFakhir.deliverables': 'படைப்புத் திசை, பிரச்சாரக் கருத்துகள், சமூக உள்ளடக்க அமைப்பு, விளம்பரக் கருவிகள் மற்றும் காட்சி வழிகாட்டி.',
    'portfolio.project.mahanama.teaser': 'நிறுவன நம்பிக்கையையும் டிஜிட்டல் தெளிவையும் ஒரே பயணத்தில் இணைக்கும் நவீன கல்வித் தளம்.',
    'portfolio.project.mahanama.overview': 'தகவலை எளிதாகக் கண்டுபிடிக்கச் செய்து நிறுவனத்தை நம்பிக்கையுடனும் பொருத்தத்துடனும் காட்டும் இணைய மற்றும் பிரச்சாரத் திசை.',
    'portfolio.project.mahanama.challenge': 'நிறுவனத்தின் வரலாறு, நம்பிக்கை மற்றும் மனிதத் தன்மையை இழக்காமல் பல்வேறு பயனர்கள் முக்கியத் தகவலை விரைவாக அணுக வேண்டும்.',
    'portfolio.project.mahanama.approach': 'மாணவர்களையும் குடும்பங்களையும் மையமாகக் கொண்ட தெளிவான தகவல் வரிசை, நவீன காட்சி மொழி மற்றும் பிரச்சாரக் கட்டமைப்பை உருவாக்கினோம்.',
    'portfolio.project.mahanama.deliverables': 'இணைய உத்தி, தகவல் கட்டமைப்பு, பிராண்ட் மேம்பாடு, பிரச்சாரக் கருவிகள் மற்றும் பதிலளிக்கும் இடைமுகத் திசை.',
    'portfolio.project.luckyDarbar.teaser': 'சுவை, ஆற்றல் மற்றும் விருந்தோம்பலை ஒவ்வொரு பிரச்சாரத்திலும் வெளிப்படுத்தும் உயிருள்ள உணவு அடையாளம்.',
    'portfolio.project.luckyDarbar.overview': 'ஒவ்வொரு செய்தியையும் ஒரே பிராண்ட் உலகில் வைத்துக்கொண்டு Lucky Darbar-க்கு விரைவாகச் சலுகைகளை வெளியிட உதவும் படைப்பாற்றல் அமைப்பு.',
    'portfolio.project.luckyDarbar.challenge': 'அடிக்கடி வரும் சலுகைகள் தொடர்பில்லாமல் தோன்றியதால் சலுகையை வாசிப்பதற்கு முன்பே பிராண்டை அடையாளம் காண்பது கடினமானது.',
    'portfolio.project.luckyDarbar.approach': 'ஒற்றுமையை இழக்காமல் வேகமாக செயல்பட வலுவான காட்சி குறியீடுகள், மீள்பயன்பாட்டு உள்ளடக்க அமைப்புகள் மற்றும் வார்ப்புருக்களை உருவாக்கினோம்.',
    'portfolio.project.luckyDarbar.deliverables': 'பிராண்ட் வெளிப்பாடு, விளம்பர அமைப்பு, சமூக வார்ப்புருக்கள், சலுகைப் படைப்புகள் மற்றும் மாதாந்திர உள்ளடக்கத் திசை.',
    'portfolio.project.craneShoes.teaser': 'தயாரிப்பு நம்பிக்கை, தெளிவான கண்டுபிடிப்பு மற்றும் வலுவான டிஜிட்டல் பிராண்டை இணைக்கும் சில்லறை அனுபவம்.',
    'portfolio.project.craneShoes.overview': 'வாடிக்கையாளர்கள் தயாரிப்புகளை விரைவாகக் கண்டுபிடிக்கவும் Crane Shoes-க்கு தனித்துவமான சில்லறை இருப்பை வழங்கவும் உருவாக்கப்பட்ட இணைய மற்றும் பிராண்ட் கட்டமைப்பு.',
    'portfolio.project.craneShoes.challenge': 'நடைமுறை வாங்கும் முடிவுகளையும் பிராண்ட் விருப்பத்தையும் ஆதரிக்கும் தெளிவான டிஜிட்டல் வரிசையும் காட்சி அமைப்பும் தேவைப்பட்டது.',
    'portfolio.project.craneShoes.approach': 'எளிய கண்டுபிடிப்பு, நம்பிக்கையான தயாரிப்பு காட்சி மற்றும் பருவத் தேவைகளுடன் நகரும் நெகிழ்வான சமூக மொழியை முன்னிலைப்படுத்தினோம்.',
    'portfolio.project.craneShoes.deliverables': 'இணையத் திசை, தயாரிப்பு கண்டுபிடிப்பு அமைப்பு, பிராண்ட் மேம்பாடு, சமூகக் கருவிகள் மற்றும் சில்லறைப் பிரச்சார வார்ப்புருக்கள்.',
    'portfolio.project.flyBagdad.teaser': 'பயணத் தேடலைத் தெளிவாகவும் வேகமாகவும் நடவடிக்கைக்குத் தயாராகவும் மாற்றும் டிஜிட்டல் பயணம்.',
    'portfolio.project.flyBagdad.overview': 'இலக்கு கண்டுபிடிப்பை ஆர்வத்திலிருந்து விசாரணை வரை எளிய பாதையுடன் இணைக்கும் மாற்று மைய இணைய மற்றும் பிரச்சாரத் திசை.',
    'portfolio.project.flyBagdad.challenge': 'பயணத் தேர்வுகள் பயனர்களை குழப்பாமல் ஊக்கமளிக்க வேண்டும்; தொடர்ச்சிப் பணிகளில் கைமுறை இடையூறும் குறைய வேண்டும்.',
    'portfolio.project.flyBagdad.approach': 'இலக்கு நோக்கத்தைச் சுற்றி பயணத்தை எளிமைப்படுத்தி, தெளிவான பிரச்சாரப் பாதைகளையும் முக்கிய விசாரணைகளுக்கான தானியக்கத்தையும் வடிவமைத்தோம்.',
    'portfolio.project.flyBagdad.deliverables': 'இணையப் பயணம், பிரச்சார இறங்குப் பக்கங்கள், இலக்கு உள்ளடக்க அமைப்பு, விசாரணை தானியக்கம் மற்றும் மாற்றுப் படைப்புகள்.',
  });
  ...
  function applyTranslations(lang) {
    ...
    document.dispatchEvent(new CustomEvent('cambm:localechange', { detail: { language: lang } }));
  }
  ...
  function applySocialLinks(countryCode) {
    ...
    document.querySelectorAll('.js-region-whatsapp').forEach(function (link) {
      link.href = 'https://wa.me/' + whatsappNumber + '?text=' + WHATSAPP_MESSAGE;
    });
