...
(function () {
  ...
  TRANSLATIONS.en = {
    ...
    'nav.systems': 'Systems', 'nav.whyCambm': 'Why CAMBM', 'nav.services': 'Services', 'nav.packages': 'Packages', 'nav.ourProducts': 'Our Products', 'nav.ourProjects': 'Our Products', 'nav.ourPricing': 'Packages', 'nav.bookCall': 'Book a strategy call',
  ...
  TRANSLATIONS.es = {
    ...
    'nav.systems': 'Sistemas', 'nav.whyCambm': 'Por qué CAMBM', 'nav.services': 'Servicios', 'nav.packages': 'Paquetes', 'nav.ourProducts': 'Nuestros Productos', 'nav.ourProjects': 'Nuestros Productos', 'nav.ourPricing': 'Paquetes', 'nav.bookCall': 'Reservar una llamada',
  ...
  TRANSLATIONS.ar = {
    ...
    'nav.systems': 'الأنظمة', 'nav.whyCambm': 'لماذا كامبريدج', 'nav.services': 'الخدمات', 'nav.packages': 'الباقات', 'nav.ourProducts': 'منتجاتنا', 'nav.ourProjects': 'منتجاتنا', 'nav.ourPricing': 'الباقات', 'nav.bookCall': 'احجز مكالمة استراتيجية',
  ...
  TRANSLATIONS.si = {
    ...
    'nav.systems': 'පද්ධති', 'nav.whyCambm': 'මන්ද කැම්බ්‍රිජ්', 'nav.services': 'සේවා', 'nav.packages': 'පැකේජ', 'nav.ourProducts': 'අපගේ නිෂ්පාදන', 'nav.ourProjects': 'අපගේ නිෂ්පාදන', 'nav.ourPricing': 'පැකේජ', 'nav.bookCall': 'උපායමාර්ග ඇමතුමක් වෙන් කරන්න',
  ...
  TRANSLATIONS.ta = {
    ...
    'nav.systems': 'அமைப்புகள்', 'nav.whyCambm': 'ஏன் கேம்ப்ரிட்ஜ்', 'nav.services': 'சேவைகள்', 'nav.packages': 'தொகுப்புகள்', 'nav.ourProducts': 'எங்கள் தயாரிப்புகள்', 'nav.ourProjects': 'எங்கள் தயாரிப்புகள்', 'nav.ourPricing': 'தொகுப்புகள்', 'nav.bookCall': 'மூலோபாய அழைப்பை பதிவு செய்யவும்',
